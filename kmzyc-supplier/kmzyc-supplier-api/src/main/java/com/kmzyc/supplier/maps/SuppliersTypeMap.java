...
public class SuppliersTypeMap {
	...
	public static Map<Short, String> getMap() {
		if (map == null) {
			...
			maps.put(SuppliersType.EMTER.getStatus(),
					SuppliersType.EMTER.getTitle());
			maps.put(SuppliersType.SELL.getStatus(),
					SuppliersType.SELL.getTitle());
			maps.put(SuppliersType.SUPPORT.getStatus(),
					SuppliersType.SUPPORT.getTitle());
			map = maps;
		}
		return map;
	}
