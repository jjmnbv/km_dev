...
<s:form action="/product/saveImage.action" method="POST" id="frm" name='frm' enctype="multipart/form-data" >
  	...
  	<div class="fbphoto" data-id="<s:property value="#sku.productSkuId" />">
		...
		<ul id="uploadpreview<s:property value="#sku.productSkuId" />">
			<s:iterator value="#sku.productSkuImages" var="pi" status="st">
				...
				<input type=hidden value='<s:property value="#pi.skuId" />,<s:property value="#pi.imageId" />,this.parentNode.parentNode.parentNode'/>
