            ...
            <div class="row-fluid">
                ...
                <div class="block_01">
                    ...
                    <div class="block-content collapse in">
                        ...
                        <%--搜索开始--%>
                        <s:form action="/supplierActivityResultAction/findMyTeletextActivitySales.action" method="post" id="frm" name="frm">
                            ...
                            <div class="com_topform">
                                <ul>
                                    ...
                                    <li>
                                        <a class="btn width66 btn-mini btn-primary teleText_search" >搜索</a>
                                    </li>
                                </ul>
                            </div>
                            <%--搜索结束--%>
