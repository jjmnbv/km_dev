...
<link type="text/css" rel="stylesheet" href="<%=staticUrl%><%=cssBaseUrl%>block.css?version=<%=version%>"/>
...
<script type="text/javascript" src="<%=staticUrl%><%=jsBaseUrl%>common/jquery-1.8.3.js?version=<%=version%>"></script>
<script type="text/javascript" src="<%=staticUrl%><%=jsBaseUrl%>common/jquery.blockUI.js?version=<%=version%>"></script>
...
<script type="text/javascript">	
seajs.use(['<%=staticUrl%><%=jsBaseUrl%>view/common2.js']); 
<%
    if(!rootPage){
%>
