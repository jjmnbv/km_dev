...
<%--
 ...
 --%><span class="ui-page-item ui-page-item-info ui-page-text">每页
 			<!-- pengbo 原版本为pageSize1   现改为pageSize
 			<s:select id="pageSize" name="pageSize1" list="#{10:'10',20:'20',30:'30',50:'50'}"/>
 			 -->
			<s:select id="pageSize" name="pageSize" list="#{10:'10',20:'20',30:'30',50:'50'}" cssStyle="width:60px"/>
			条</span>
			<input type="hidden" value="bottom" name="">
		<span class="ui-page-item ui-page-item-info ui-page-text">共${pagintion.totalpage}页&nbsp;&nbsp;${pagintion.totalRecords}条记录&nbsp;&nbsp;到第</span><span><input type="text" id="gotoPageBottom" name="gotoPageBottom" value="${page}" maxlength="4" class="ui-page-number"></span><span class="ui-page-item ui-page-item-info ui-page-text">页</span><span><input name="gotoPage2"  type="button" id="gotoPage2" class="ui-page-btnconfirm" value="确定"></span>
	</div>
</div>
<%--</kh:html>--%>