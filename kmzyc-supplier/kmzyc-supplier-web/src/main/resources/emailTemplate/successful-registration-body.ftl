        ...
        <div class="l-w fn-clear">
        	<div class="mail-con">
            	<div class="hellow fn-bottom-dashed">
                	...
                	<p class="fn-green">感谢您注册康美中药城<br>我们将为您提供最贴心的服务，祝您购物愉快！</p>
                </div>
                <div class="user">
                	<ul>
                    	<li>您的注册用户名：${loginName}</li>
                        <li>您的注册邮箱：<strong class="fn-green">${userEmail}</strong></li>
                    </ul>
                </div>
                <div class="text-con">
                	<h5>安全提示：</h5>
                    <p>为了您的账户安全，我们建议您点击以下链接验证邮箱： <a href="${userUrl}" class="fn-blue">${userUrl}
</a>请在24小时内点击该链接，您也可以将链接复制到浏览器地址栏访问。</p>
                </div>
                <p class="user fn-bottom-dashed">邮件中包含您的个人信息，建议您保管好本邮件！如您登陆时忘记密码，请点此 <a href="#" class="fn-green">找回密码</a>。</p>
        <!--内容区 END-->	
        <!-- 底部特别推荐商品 -->
