...
/**
 * 产品搭售操作 对应 ProcutMain PRODUCT_DKU 两张表
 * 
...
public interface ProductmainTiedDAO {
    ...
    List<ProductmainTied> selectListExcepMainsku(ProductmainTied prod, Page page)
            throws SQLException;
    ...
    /**
     * 根据skuCode 查询出ProductMain 的对象出来
     * 
     * @param skuCode
     * @return
     * @throws SQLException
    ...
    /**
     * 根据skuId 查询出对应的productMainTied 对象
     * 
     * @param skuList
     * @return
     * @throws SQLException
