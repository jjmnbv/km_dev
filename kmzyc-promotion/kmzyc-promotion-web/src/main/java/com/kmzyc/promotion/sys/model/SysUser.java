...
public class SysUser implements Serializable {
  ...
  public boolean equals(Object that) {
    ...
    return this.getUserId() == null ? other == null
        : this.getUserId().equals(other.getUserId()) && this.getDeptId() == null ? other == null
            : this.getDeptId().equals(other.getDeptId()) && this.getUserName() == null
                ? other == null
                : this.getUserName().equals(other.getUserName()) && this.getUserPwd() == null
                    ? other == null
                    : this.getUserPwd().equals(other.getUserPwd()) && this.getUserReal() == null
                        ? other == null
                        : this.getUserReal().equals(other.getUserReal())
                            && this.getUserSex() == null
                                ? other == null
                                : this.getUserSex().equals(other.getUserSex())
                                    && this.getUserBirthday() == null
                                        ? other == null
                                        : this.getUserBirthday().equals(other.getUserBirthday())
                                            && this.getUserCardno() == null
                                                ? other == null
                                                : this.getUserCardno().equals(other.getUserCardno())
                                                    && this.getUserPhone() == null
                                                        ? other == null
                                                        : this.getUserPhone()
                                                            .equals(other.getUserPhone())
                                                            && this.getUserMphone() == null
                                                                ? other == null
                                                                : this.getUserMphone()
                                                                    .equals(other.getUserMphone())
                                                                    && this.getUserIp() == null
                                                                        ? other == null
                                                                        : this.getUserIp().equals(
                                                                            other.getUserIp())
                                                                            && this
                                                                                .getUserLasttime() == null
                                                                                    ? other == null
                                                                                    : this
                                                                                        .getUserLasttime()
                                                                                        .equals(
