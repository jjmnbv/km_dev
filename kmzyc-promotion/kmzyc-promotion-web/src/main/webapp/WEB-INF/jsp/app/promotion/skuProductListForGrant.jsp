...
<s:form action="/promotion/findAllProductSkuForGrant.action" method="POST"   id="frm" name='frm' >
<s:hidden id="promotionId" name="promotionProduct.promotionId"></s:hidden>
<s:hidden id="promotionId" name="promotionProduct.promotionProductId"></s:hidden>
...
function selectProduct(){
        ...
        parent.receiveProductForGrant(idArray,nameArray);
