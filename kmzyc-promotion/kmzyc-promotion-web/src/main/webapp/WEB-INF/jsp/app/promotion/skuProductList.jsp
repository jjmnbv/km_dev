...
<s:form action="/promotion/findAllProductSku.action" method="POST"   id="frm" name='frm' >
...
function selectProduct_back(){
	...
	if (type!='undefined'&&type!=null&&type==5) {
		...
		location.href="/promotion/addPromotionProduct.action?promotionProduct.promotionId="+$("#promotionId").val()+"&promotionProduct.productSkuIds="+ids.substr(1);
	}
}
