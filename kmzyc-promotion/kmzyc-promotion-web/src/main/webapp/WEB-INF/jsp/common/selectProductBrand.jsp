...
<table  width="98%" class="content_table"  height="100" align="center" cellpadding="0" cellspacing="0" >
	<tr>
		...
		<td>
			&nbsp;&nbsp;&nbsp;&nbsp;
			<INPUT TYPE="button" onclick="doSearch()" class="queryBtn" value="" onkeydown="if(event.keyCode==13)return false;">
		</td>
	</tr>
</table>
...
<table  width="98%" align="center" cellpadding="0" cellspacing="0">
	...
	<tr>
			<td align="center"><INPUT class="saveBtn" TYPE="button"
				value="" onclick="return save();" onkeydown="if(event.keyCode==13){return false;}">
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
			<input type="button" class="backBtn" onClick="javascript:parent.myDialog.close();" onkeydown="if(event.keyCode==13)return false;" />
