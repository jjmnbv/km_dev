...
/**
 * 产品+SKU类 此类无实体表，主要是为了映射多表查询用 在价格缓存，远程接口都有使用
 * 
 * @author luoyi
 */
public class ProductAndSku extends BaseBean implements java.io.Serializable {
  ...
  public String toString() {
    return "ProductAndSku [categoryId=" + categoryId + ", productId=" + productId + ", productDesc="
        + productDesc + ", keyword=" + keyword + ", productHot=" + productHot + ", productTitle="
        + productTitle + ", packListing=" + packListing + ", introduce=" + introduce + ", status="
        + status + ", archiveTime=" + archiveTime + ", checkUser=" + checkUser + ", checkUserName="
        + checkUserName + ", checkTime=" + checkTime + ", modifTime=" + modifTime + ", modifUser="
        + modifUser + ", shopCode=" + shopCode + ", upTime=" + upTime + ", marketPrice="
        + marketPrice + ", costPrice=" + costPrice + ", productNo=" + productNo + ", brandId="
        + brandId + ", brandName=" + brandName + ", productSkuId=" + productSkuId
        + ", productSkuCode=" + productSkuCode + ", approvalNo=" + approvalNo + ", approvalType="
        + approvalType + ", categoryName=" + categoryName + ", productSkus=" + productSkus
        + ", categoryAttrList=" + categoryAttrList + ", productAttrList=" + productAttrList
