...
public class StockOutAndDetail implements Serializable {
	...
	public String toString() {
		return "StockOutAndDetail [stockOutId=" + stockOutId + ", warehouseId=" + warehouseId + ", status=" + status
				+ ", type=" + type + ", detailId=" + detailId + ", stockId=" + stockId + ", productSkuId="
				+ productSkuId + ", productSkuValue=" + productSkuValue + ", quantity=" + quantity + "]";
	}
