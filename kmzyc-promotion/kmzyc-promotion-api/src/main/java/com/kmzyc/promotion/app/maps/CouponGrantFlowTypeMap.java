...
public class CouponGrantFlowTypeMap {
	...
	public static Map<String, String> getMap() {
		...
		maps.put(CouponGrantFlowStatus.GIVE_COUPONFLOWSTATUS.getType(), CouponGrantFlowStatus.GIVE_COUPONFLOWSTATUS
				.getTitle());
		maps.put(CouponGrantFlowStatus.FREEZE_COUPONFLOWSTATUS.getType(), CouponGrantFlowStatus.FREEZE_COUPONFLOWSTATUS
				.getTitle());
