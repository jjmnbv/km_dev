...
/**
 * 出库单+退货单(AftersaleReturnOrder)部分数据实体类
 * 
 * @author luoyi
 * @createDate 2013/12/09
 * 
 */
public class StockOutAftersaleReturn implements java.io.Serializable {

	private static final long serialVersionUID = -4232360913161374545L;

	/**
	 * StockOut无参构造方法
	 */
	public StockOutAftersaleReturn() {
	...
	private Integer custId;// 退货客户ID

	private String custName;// 退货客户名称

	private String shipAddress;// 退货收货地址

	private String linkPhone;// 退货收货电话
	...
	public String toString() {
		return "StockOutAftersaleReturn [stockOutId=" + stockOutId + ", customerTypeId=" + customerTypeId
				+ ", stockOutNo=" + stockOutNo + ", warehouseId=" + warehouseId + ", type=" + type + ", userId="
				+ userId + ", userName=" + userName + ", totalQuantity=" + totalQuantity + ", taxSum=" + taxSum
				+ ", totalTax=" + totalTax + ", totalSum=" + totalSum + ", createUser=" + createUser
				+ ", createUserName=" + createUserName + ", createDate=" + createDate + ", auditUser=" + auditUser
				+ ", checkUserName=" + checkUserName + ", auditDate=" + auditDate + ", status=" + status
				+ ", dayEndStatus=" + dayEndStatus + ", remark=" + remark + ", billNo=" + billNo + ", modifiyDate="
				+ modifiyDate + ", modifierId=" + modifierId + ", modifierName=" + modifierName + ", returnNo="
				+ returnNo + ", custId=" + custId + ", custName=" + custName + ", shipAddress=" + shipAddress
				+ ", linkPhone=" + linkPhone + "]";
	}
