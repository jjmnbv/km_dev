 ...
 * @since 2013-07-26
 */
public class BnesVouchersQuery implements Serializable {
  ...
  public BnesVouchersQuery() {
    super();
  }

  public BnesVouchersQuery(Integer vouchersId, Integer accountId, String name, Date valid,
