 ...
 * @since 2013-07-26
 */
public class BnesPasswordQuery implements Serializable {
  ...
  public BnesPasswordQuery() {
    super();
  }

  public BnesPasswordQuery(Integer accountId, Integer userId, Date createDate, String code,
