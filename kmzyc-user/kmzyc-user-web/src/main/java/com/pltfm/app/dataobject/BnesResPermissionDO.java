 ...
 * @since 2013-07-17
 */
public class BnesResPermissionDO implements Serializable {
  ...
  public BnesResPermissionDO() {
    super();
  }

  public BnesResPermissionDO(Integer resPermissionId, Integer customerTypeId,
