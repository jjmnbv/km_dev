 ...
 * @since 2013-07-26
 */
public class BnesAuthenticationInfoQuery implements Serializable {
  ...
  public BnesAuthenticationInfoQuery() {
    super();
  }

  public BnesAuthenticationInfoQuery(Integer authenticationId, Integer accountId,
