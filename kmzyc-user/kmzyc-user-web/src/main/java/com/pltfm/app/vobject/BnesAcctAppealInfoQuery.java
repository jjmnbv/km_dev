 ...
 * @since 2013-07-26
 */
public class BnesAcctAppealInfoQuery implements Serializable {
  ...
  public BnesAcctAppealInfoQuery() {
    super();
  }

  public BnesAcctAppealInfoQuery(Integer accountAppealId, Integer accountId, Integer disposePerson,
