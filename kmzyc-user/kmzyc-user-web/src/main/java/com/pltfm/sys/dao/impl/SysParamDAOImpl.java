...
public class SysParamDAOImpl implements SysParamDAO {
  ...
  public int countByExample(SysParamExample example) throws SQLException {
    Integer count =
        (Integer) sqlMapClient.queryForObject("SYS_PARAM.ibatorgenerated_countByExample", example);
    return count;
  }
  ...
  public List<SysParam> selectByExample(SysParamExample example) throws SQLException {
    List<SysParam> list =
        sqlMapClient.queryForList("SYS_PARAM.ibatorgenerated_selectByExample", example);
    return list;
  }
   ...
   * @ibatorgenerated Thu Nov 24 14:28:04 CST 2011
   */
  public int updateByExampleSelective(SysParam record, SysParamExample example)
      throws SQLException {
