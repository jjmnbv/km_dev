...
public class SysNoticeAction extends ActionSupport implements ModelDriven {
  ...
  public String gotoList() throws Exception {
    ...
    try {
      ...
      Page returnPage = sysNoticeService.searchPageByVo(this.getPage(), sysnotice);
  ...
  public String doSave() throws Exception {
    ...
    try {
      // 保存公告
      Integer noticeId = sysNoticeService.doSave(sysnotice);
      log.warn("---------- added noticeId=" + noticeId);
      // 发送公告（非草稿）
      if (!"0".equals(sysnotice.getNoticeSt())) sysNoticeService.sendNotice(noticeId, userIdStr);
  ...
  public String doDelete() throws Exception {
    ...
    try {
      sysNoticeService.doDelete(delId);
    } catch (Exception e) {
      e.printStackTrace();
      return ERROR;
    }
  ...
  public String getDetail() throws Exception {
    ...
    try {
      // 公告信息
      this.sysnotice = sysNoticeService.getDetail(noticeId);
      // 公告发送信息
      List sendList = sysNoticeService.getSendListByNoticeId(sysnotice.getNoticeId());
      userIdStr = "";
      userNameStr = "";
  ...
  public String doUpdate() throws Exception {
    ...
    try {
      // 修改公告
      sysnotice = sysNoticeService.doUpdate(sysnotice);
    } catch (Exception e) {
      e.printStackTrace();
      return ERROR;
    }
  ...
  public String doUpdateAndSend() throws Exception {
    ...
    try {
      ...
      sysnotice = sysNoticeService.doUpdate(sysnotice);
      // 发送公告
      sysNoticeService.sendNotice(sysnotice.getNoticeId(), userIdStr);
    } catch (Exception e) {
      e.printStackTrace();
      return ERROR;
    }
  ...
  public String doDisable() throws Exception {
    ...
    try {
      sysnotice = sysNoticeService.doUpdate(sysnotice); // 修改
    } catch (Exception e) {
      e.printStackTrace();
      return ERROR;
    }
  ...
  public String getMyNoticeList() throws Exception {
    ...
    try {
      ...
      Page returnPage = sysNoticeService.searchMyNoticePageByVo(this.getPage(), sysnotice);
      this.setPage(returnPage);
    } catch (Exception e) {
      e.printStackTrace();
      return ERROR;
  ...
  public String getMyNoticeDetail() throws Exception {
    ...
    try {
      ...
      this.sysnotice = sysNoticeService.getDetail(noticeId);
      // 公告已读状态
      sysNoticeService.setIsRead(sysnotice.getNoticeId(), su.getUserId());
  ...
  public String doDeleteMyNotice() throws Exception {
    ...
    SysUser su = (SysUser) session.get("sysUser");
    try {
      sysNoticeService.doDeleteMyNotice(delId, su.getUserId());
    } catch (Exception e) {
      e.printStackTrace();
      return ERROR;
    }
  ...
  public String ajaxGetHomeMainMyNotice() throws Exception {
    ...
    SysUser su = (SysUser) session.get("sysUser");
    try {
      dataList = sysNoticeService.getMyNoticeList(su.getUserId());
    } catch (Exception e) {
      e.printStackTrace();
      return ERROR;
    }
