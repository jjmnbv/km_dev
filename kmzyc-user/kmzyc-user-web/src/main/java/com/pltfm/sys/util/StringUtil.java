...
public class StringUtil {
    ...
    /**
     * 将用split的字符串转换为数组，转换时去除“”字段
     * @author xuyuliang 
     * @param s
     * @param split
     * @return
     */
    public static final List<String> asListExcludeBlank(String s, String split){
  ...
  public synchronized static final String hash(String data) {
    if (digest == null) {
      try {
        ...
        // System.err.println("Failed to load the MD5 MessageDigest. " + "Jive will be unable to
        // function normally.");
