...
<table width="98%" align="center" class="topbuttonbar" height="30" border="0" cellpadding="0" cellspacing="0">
	<tr> 
	    <td width="90%" valign="middle">
            <INPUT class="btn-custom btngreen" TYPE="submit" value=" 保存 ">
            <INPUT class="btn-custom btngreen" TYPE="button" value=" 预览sql语句 " onClick="viewSql();">
			<INPUT class="btn-custom btngreen" TYPE="button" value=" 报表查询 " onClick="gotoSearch(<s:property value='model.reportId'/>);">
		</td>
