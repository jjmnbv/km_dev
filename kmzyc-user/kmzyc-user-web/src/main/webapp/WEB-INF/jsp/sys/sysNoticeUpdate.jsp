...
<table width="98%" align="center" class="topbuttonbar" height="30" border="0" cellpadding="0" cellspacing="0">
	<tr> 
	    <td width="90%" valign="middle">
			...
			<!-- 已发送的重发 -->
			<INPUT class="btngreen" TYPE="button" value=" 重新发送 " onClick="doUpdateAndSend()">
			</s:if>

			<s:if test='model.noticeSt.equals("0")'>
			<!-- 草稿发送 -->
			<INPUT class="btn-custom btngreen" TYPE="button" value=" 保存草稿 " onClick="doUpdate()">
			<INPUT class="btn-custom btngreen" TYPE="button" value=" 保存并发送 " onClick="doUpdateAndSend()">
			</s:if>

			<INPUT class="btn-custom btngreen" TYPE="button" value=" 置为无效 " onClick="doDisable()">
		</td>
...
<table width="98%" align="center" class="bottombuttonbar" height="30" border="0" cellpadding="0" cellspacing="0">
	<tr> 
		<td width="90%" valign="middle">
			...
			<s:if test='model.noticeSt.equals("0")'>
			<!-- 草稿发送 -->
			<INPUT class="btngreen" TYPE="button" value=" 保存草稿 " onClick="doUpdate()">
			<INPUT class="btngreen" TYPE="button" value=" 保存并发送 " onClick="doUpdateAndSend()">
			</s:if>

			<INPUT class="btngreen" TYPE="button" value=" 置为无效 " onClick="doDisable()">
		</td>
		<td width="10%" align="center"><a href="#" onClick="gotoList();"><input class="backBtn" onclick="gotoList()" type="button" value=""></a></td>
	</tr>
</table>
