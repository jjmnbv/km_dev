...
<table width="180" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="180" height="86" valign="middle" >
    <div id="menutop"><br/><span style='font-family:"宋体";color:#AE0000;font-size:14px;font-weight:bold;'><s:property value="topMenuName" /></span></div>	
   </td>
  </tr>
  <tr>
    <td width="180" align="center" valign="top" background="/etc/images/sys/menu_bg.gif">
	<div id="menubg">
