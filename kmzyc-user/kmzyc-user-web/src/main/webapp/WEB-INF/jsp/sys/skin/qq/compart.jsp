...
<div id="compart_qq"><p><img src="/etc/images/sys/compart_button.gif" style="cursor:hand" alt="隐藏菜单" width="5" height="94" onclick="javascript:Show_Hide_Menu();" id="menuICON" /></p></div>
