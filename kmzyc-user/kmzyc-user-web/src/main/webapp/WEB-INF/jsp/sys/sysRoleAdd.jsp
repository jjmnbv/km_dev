...
<Script  src="/etc/js/sys/sysRoleAdd.js" type="text/javascript"></Script>
</head>
<body onkeydown="changeKey();">
<!-- 导航栏 -->
<s:set name="parent_name" value="'系统配置'" scope="request" />
<s:set name="name" value="'角色管理'" scope="request" />
<s:set name="son_name" value="'添加角色'" scope="request" />
<jsp:include page="/WEB-INF/jsp/common/title.jsp"></jsp:include>
<s:form action="saveSysRole.action" method="POST"  namespace='/sys' onsubmit="return Validator.Validate(this,3)">
...
<!-- 底部 按钮条 -->
<table width="60%" class="edit_bottom" height="30" border="0" cellpadding="3" cellspacing="0">
	<tr> 
		<td align="center">
