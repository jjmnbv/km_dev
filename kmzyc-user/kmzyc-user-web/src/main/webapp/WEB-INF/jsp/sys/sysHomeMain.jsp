...
body{margin:0;padding:0 0 12px 0;font-size:12px;line-height:22px;font-family:"Microsoft YaHei",微软雅黑,"Helvetica Neue",Helvetica,Arial,sans-serif;background:url(/etc/images/cloud.png);background-repeat:no-repeat;background-attachment:fixed;background-position:bottom}
...
#rightblockInfo li{background:url(/etc/images/q_bar.png) -392px -312px no-repeat;margin:0 0 0 4px;padding:0;font-size:12px;font-family:"Microsoft YaHei",微软雅黑,"Helvetica Neue",Helvetica,Arial,sans-serif;list-style-type:none}
-->
</style>
</head>
<body >
