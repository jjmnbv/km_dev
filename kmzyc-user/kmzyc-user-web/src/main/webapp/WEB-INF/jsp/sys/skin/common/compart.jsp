...
<div id="compart_common"><p><img src="/etc/images/sys/compart_button.gif" style="cursor:hand" alt="隐藏菜单" width="7" height="94" onClick="javascript:Show_Hide_Menu();" id="menuICON" /></p></div>
