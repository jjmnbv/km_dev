...
<table width="98%" align="center" class="topbuttonbar" height="30" border="0" cellpadding="0" cellspacing="0">
	<tr> 
	    <td width="90%" valign="middle">
            <INPUT class="btn-custom btngreen" TYPE="button" value=" 保存并发送 " onClick="saveAndSend()">
			<INPUT class="btn-custom btngreen" TYPE="button" value="存为草稿" onClick="saveDraft()">
		</td>
	    <td width="10%" align="center"><a href="#" class="backBtn" onClick="gotoList();"><input class="backBtn" onclick="gotoList()" type="button" value=""></a></td>
	</tr>
</table>
