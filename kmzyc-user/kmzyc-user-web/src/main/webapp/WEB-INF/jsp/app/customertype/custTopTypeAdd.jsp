...
<table width="60%" class="edit_table" cellpadding="3" cellspacing="0" border="1" bordercolor="#C7D3E2" style="border-collapse: collapse">
	<tr> 
		<th colspan="2" align="left" class="edit_title">新增客户类别信息:</th>
		</tr>
<tr> 
			<td width="20%"  class="eidt_rowTitle" ><font color="red">*</font>类别名称：</td>
			<td width="80%" >
				<input id ="name" name="name" type="text" size="40" value="<s:property value='name'/>"/>
			</td>
		</tr>
...
function saveCutType(){

window.document.updateForm.action = "cust_saveCutType.action";
window.document.updateForm.target = "main";
window.document.updateForm.submit();
}
function gotoList(){
    location.href="/customers/cust_showCustType.action";
}
</SCRIPT>
</BODY>
</HTML>