...
<title>添加医务专属信息</title>
<link href="/etc/css/style_sys.css" type="text/css" rel="stylesheet">
<Script language="JavaScript" src="/etc/js/Form.js" type="text/javascript"></Script>
</head>
<body>

<s:form action="/mdicalExcusie/mdicalExcusie_add.action" method="POST"  namespace='/mdicalExcusie' >
...
<table width="95%" class="tableInput1" align="center" cellpadding="3" cellspacing="0" border="1" bordercolor="#C7D3E2" style="border-collapse: collapse">
   ...
   <tr> 
		...
		<td width="80%"> 
			...
			dataType="LimitB" max="15" min="1" msg="姓名，不能为空" value=""/>
		</td>
	</tr>
	...
	<tr> 
		...
		<input name="mdicalExcusieInfo.theCity" type="text" require="true" 
			dataType="LimitB" max="15" min="1" msg="所在城市，不能为空" value=""/>
		</td>
	</tr>
	...
	<tr> 
		...
		<td width="80%"> 
			...
			dataType="LimitB" max="16" min="1" msg="所属医院，不能为空" value=""/>
		</td>
	</tr>
	...
	<tr> 
		...
		<td width="80%"> 
			...
			dataType="LimitB" max="40" min="1"  value=""/>
		</td>
	</tr>
    ...
    <tr> 
		...
		<td width="80%"> 
			...
			require="true" dataType="LimitB" max="22" min="1"  value=""/>
		</td>
	</tr>
     <tr> 
	 ...
	 <tr> 
		...
		<td width="80%"> 
			...
			dataType="LimitB" max="22" min="1" msg="号码，不能为汉字 " value=""/>
		</td>
	</tr>
	<tr> 
