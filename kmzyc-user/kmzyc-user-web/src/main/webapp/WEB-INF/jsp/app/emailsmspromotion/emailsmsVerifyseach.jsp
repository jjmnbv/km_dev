		...
		<div style="height: 90%; overflow-y: scroll;">
			...
			<s:form action="/emailsmsverify/emailsmsverify_EditVerifyStatus.action" id="emailsmsverifyMessageForm"
				...
				<table width="80%" class="edit_table" cellpadding="3"
					...
					<tr>
						...
						<td width="80%">
							...
							<select name="emailSmsPromotion.promotionType" onchange="changeShowType(this.value)" readonly="readonly"  id="promotionType" disabled>
								<option value="1"
		      ...
		      <input type="hidden" name="emailSmsPromotion.smsType"  
					...
					<%--删除邮件业务 <tr id="emailContextId"  style="display:none;" >
					<td width="20%" align="right"> 
					...
					<tr>
						...
						<td width="80%">
						  ...
						  <input type="hidden" name="emailSmsPromotion.isTime"  
							...
							<select name="emailSmsPromotion.isTime"  readonly="readonly"   onchange="changeIsTime(this.value)"  id="isTime"  disabled >
								<option value="0"
