...
/** 通过登录账号id查询账户详细信息  **/
 ...
 function showUploadPictur(picName ,imgUrl){
	 if(imgUrl){
		 openwindow(imgUrl,"_blank", document.body.clientWidth, document.body.clientHeight);	 
	 }else{
		 alert('没有上传合适的' + picName+'，不能放大查看...');
	 }
...
<table width="90%" class="edit_table" cellpadding="3" cellspacing="0" border="1" bordercolor="#C7D3E2" style="border-collapse: collapse">
	...
	<td width="13%" align="right" >营业执照图片：</td>
		...
		<a href="javascript:showUploadPictur('营业执照图片','<s:property value="commercialTenantBasicInfo.uploadBusinessLicencePictur"/>')" title="单击放大"  id="hrefId101">营业执照</a>
	...
	<tr> 
	 <td width="13%" align="right" ><font color="red">*</font>企业法人身份证：</td>
		...
		<a href="javascript:showUploadPictur('身份证扫描件','<s:property value="commercialTenantBasicInfo.certificatePicture"/>')" title="单击放大" target="_blank" id="hrefId101">身份证扫描件</a>
		</td> 
	</tr>
	<tr> 
	...
	<s:select list="#request.areaList" id="area" disabled="true" name="commercialTenantBasicInfo.area" listKey="areaId" listValue="areaName"  value="#request.commercialTenantBasicInfo.area" 
	   ...
	   <img title="税务登记证(副本)" width="200" height="110" style="cursor: pointer;" src="<s:property value='commercialTenantBasicInfo.taxRegCertificateCopy'/>" />
		<a href="javascript:showUploadPictur('税务登记证(副本)','<s:property value="commercialTenantBasicInfo.taxRegCertificateCopy"/>')" title="单击放大" target="_blank" id="hrefId101">税务登记证(副本)</a>
	...
	<tr> 
	  ...
	  <img title="一般纳税人证书" width="200" height="110" style="cursor: pointer;" src="<s:property value='commercialTenantBasicInfo.taxpayerCertificate'/>" />
		<a href="javascript:showUploadPictur('一般纳税人证书','<s:property value="commercialTenantBasicInfo.taxpayerCertificate"/>')" title="单击放大" target="_blank" id="hrefId101">一般纳税人证书</a>
