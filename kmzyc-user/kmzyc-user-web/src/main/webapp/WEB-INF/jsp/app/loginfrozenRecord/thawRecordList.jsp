   ...
   /** 全选js  **/
	...
	<body>
				...
				<s:iterator id="custiterator" value="page.dataList">
					<tr>
						<%--<td align="center" width="5%">
							<input type="checkbox" name="frozenRecordIds"
								value='<s:property value="frozenRecordId"/>' />
						</td> --%>
						<td align="center">
						...
						<td align="center" title="<s:property value='frozenReason'/>">
						...
						<td align="center">
							<s:date name="sueDate" format="yyyy-MM-dd HH:mm:ss" />
						</td>
						
						<td align="center">
							<s:if test="#custiterator.status==1">
							<s:property value="sysUserName" />
							</s:if>
						</td>
						<td align="center" title="<s:property value='thawReason'/>">
						<s:if test="thawReason.length()>14">
			   		 	 <s:property value='thawReason.substring(0,14)'/>...
				 		</s:if>   
						<s:else>      
				     		<s:property value='thawReason'/>
				 		</s:else> 							
						</td>
						<td align="center">
							<s:if test="#custiterator.status==1">
							 <s:date   name="operatorDate"  format="yyyy-MM-dd HH:mm:ss"/>
							</s:if>
						</td>
						<td align="center">
							<s:if test="#custiterator.status==1"> 
		已解冻
							...
							<s:elseif test="#custiterator.status==0">
		已冻结
		</s:elseif>
						</td>
						<td>
					    <s:if test="#custiterator.status==0">
					         <img title="解冻账户" style="cursor: pointer;"
			...
			<table width="98%" align="center" class="page_table">
				<tr>
					<td><s:set name="form_name" value="'bnesFrozenRecordForm'" scope="request"></s:set> 
