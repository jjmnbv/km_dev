...
<s:form action="/userInfo/productinfo_addProducts.action"
	...
	<table width="98%" class="list_table" align="center" cellpadding="3"
		...
		<input type='checkbox' name='allbox'
								onclick="checkAll(this,'skuCodeLists')">
		</th>
		...
		<s:iterator id="productiterator" value="page.dataList" >
			<tr>
				...
				<input type="checkbox" name="skuCodeLists"
									value='<s:property value="skuCode"/>,<s:property value="productPrice" />'>
				</td>
