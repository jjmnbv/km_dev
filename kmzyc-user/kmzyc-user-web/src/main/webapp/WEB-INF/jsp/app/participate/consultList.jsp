...
<s:set name="son_name" value="'提问'" scope="request" />
		...
		<table width="98%"  class="content_table" align="center" cellpadding="0"
			...
			<tr>
				...
				<td width="15%" align="left"><input
					name="consult.productName" type="text" class="input_style"
					value="<s:property value='consult.productName'/>" /></td>
				<td width="8%" align="left">咨询内容：</td>
				<td width="15%" align="left"><input
					name="consult.consultContent" type="text" class="input_style"
					value="<s:property value='consult.consultContent'/>" /></td>
			...
			<tr>
			  ...
			  <td align="left"><input name="consult.consultStart"
					type="text" class="input_style" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" 
					value="<s:property value='consult.consultStart'/>" /></td>
				<td align="left">到</td>
				<td align="left"><input name="consult.consultEnd"
					type="text" class="input_style" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" 
					value="<s:property value='consult.consultEnd'/>"/></td>
