...
<table width="100%" cellpadding="10" cellspacing="0" border="0" bordercolor="#fff">
			 <input type="hidden"  name="commercialTenantBasicCopyDO.commercialCopyId"  id="commercialCopyId"  value="<s:property value='commercialTenantBasicCopyDO.commercialCopyId'/>"  />
			 <input type="hidden"  name="commercialTenantBasicCopyDO.loginId"  id="loginId"  value="<s:property value='commercialTenantBasicCopyDO.loginId'/>"  />
		...
		<!-- 底部 按钮条 -->
		<table width="98%" align="center" height="30"
	...
	<SCRIPT LANGUAGE="JavaScript">
		...
		function batchAuditSupplier(){
			...
			if("" == texts){
			 ...
			 $.ajax({ 
	             url: '/userInfo/commercialTenantBasicCopy_CommercialTenantBasicNoPassSupplier.action',
	             async:false,
	             data: 'commercialTenantBasicCopyDO.description='+texts+'&commercialTenantBasicCopyDO.commercialCopyId='+commercialCopyId+"&commercialTenantBasicCopyDO.loginId="+loginId,     
