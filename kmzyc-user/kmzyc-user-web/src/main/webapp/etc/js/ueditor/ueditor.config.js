...
(function () {
    ...
    var flag = 0;//1:生产环境 0:开发环境 2:测试环境
    if(({'kmuser.km1818.com':1})[window.location.hostname]){
        flag = 1;
    }else if(window.location.hostname.indexOf('10.1.6.') >= 0 || window.location.hostname.indexOf('10.1.7.') >=0){
        flag  = 2;
    }else {
		flag=0;
	}
    var editImageUrl = ["http://10.1.0.213:82/user","http://img.km1818.com/user","http://10.1.6.106:8082/user"];
    editImageUrl=editImageUrl[flag];
    /**
    ...
    window.UEDITOR_CONFIG = {
        ...
        //,imagePath:"http://10.1.0.213:82/user" 
        ,imagePath:editImageUrl
