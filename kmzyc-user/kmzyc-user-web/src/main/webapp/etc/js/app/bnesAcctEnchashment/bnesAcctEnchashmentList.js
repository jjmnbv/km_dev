//提现查看详情
function gotoDetail(enchashmentId, enchashmentResource) {
	location.href = "/accounts/bnesAcctEnchashment_gotoDetail.action?bnesAcctEnchashment.enchashmentId="
			+ enchashmentId
			+ "&bnesAcctEnchashment.enchashmentResource="
			+ enchashmentResource;
}

function gotoConfirmEditDetail(enchashmentId, enchashmentResource) {
	location.href = "/accounts/bnesAcctEnchashment_gotoDetail.action?fromConfirmMenu=yes"
			+ "&bnesAcctEnchashment.enchashmentId=" + enchashmentId
			+ "&bnesAcctEnchashment.enchashmentResource=" + enchashmentResource;
}
...
function changeDateRange() {
	...
	var jCreateBegin = $('input[name="bnesAcctEnchashment.createDateBegin"]');
	var jCreateEnd = $('input[name="bnesAcctEnchashment.createDateEnd"]');
	
	beginTime ? jCreateBegin.val(beginTime.format("yyyy-MM-dd hh:mm:ss"))
			: jCreateBegin.val('');
	endTime ? jCreateEnd.val(endTime.format("yyyy-MM-dd hh:mm:ss"))
			: jCreateEnd.val('');
}
