...
public class BnesAcctTransaction implements Serializable{
	...
	public String toString() {
		return "BnesAcctTransaction [accountTransactionId="
				+ accountTransactionId + ", accountId=" + accountId
				+ ", accountNumber=" + accountNumber + ", type=" + type
				+ ", content=" + content + ", amount=" + amount + ", status="
				+ status + ", createDate=" + createDate + ", createdId="
				+ createdId + ", modifyDate=" + modifyDate + ", modifieId="
				+ modifieId + ", tranBank=" + tranBank + "]";
	}
