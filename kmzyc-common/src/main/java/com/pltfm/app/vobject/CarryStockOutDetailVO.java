...
public class CarryStockOutDetailVO implements Serializable {
	...
	private String isPresent;//是否为赠品0：否，1：是
	...
	public String toString() {
		return "CarryStockOutDetailVO [warehouseId=" + warehouseId
				+ ", skuCode=" + skuCode + ", billDetailID=" + billDetailID
				+ ", commodityNumber=" + commodityNumber + ", unitPrice="
				+ unitPrice + ", stockId=" + stockId + "]";
	}
