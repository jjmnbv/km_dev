...
public class DistributionInfo implements Serializable {
	...
	public String toString() {
		return "DistributionInfo [distributionId=" + distributionId
				+ ", distributionNo=" + distributionNo + ", logisticsCompany="
				+ logisticsCompany + ", logisticsNo=" + logisticsNo
				+ ", warehouseId=" + warehouseId + ", warehouseName="
				+ warehouseName + ", billNo=" + billNo + ", totalQuantity="
				+ totalQuantity + ", totalSum=" + totalSum + ", userName="
				+ userName + ", deliveryAddress=" + deliveryAddress + ", tel="
				+ tel + ", logisticsDate=" + logisticsDate + ", isDeliveries="
				+ isDeliveries + ", remark=" + remark + ", createDate="
