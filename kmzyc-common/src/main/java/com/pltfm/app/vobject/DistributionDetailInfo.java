...
public class DistributionDetailInfo implements Serializable {
	...
	public String toString() {
		return "DistributionDetailInfo [detailId=" + detailId
				+ ", distributionId=" + distributionId + ", billDetailId="
				+ billDetailId + ", productId=" + productId + ", productName="
				+ productName + ", productNo=" + productNo + ", productSkuId="
				+ productSkuId + ", productSkuValue=" + productSkuValue
				+ ", quantity=" + quantity + ", price=" + price + ", sum="
				+ sum + ", remark=" + remark + "]";
	}
