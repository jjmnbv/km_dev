...
.listTitle span{padding-left:20px;height:40px;vertical-align:middle;margin:0}
.content_table,.table_search{background-color:#f5f5f5;border:1px solid #e3e3e3;-webkit-box-shadow:inset 0 1px 1px rgba(0,0,0,.05);-moz-box-shadow:inset 0 1px 1px rgba(0,0,0,.05);box-shadow:inset 0 1px 1px rgba(0,0,0,.05);overflow:hidden;padding:6px}
.table_search tr{color:#999;font-family:Arial,宋体;font-size:13px;line-height:25px;font-weight:400}
</style>
<script type="text/javascript" src="/etc/js/myModel.js"></script>
<script type="text/javascript">
$(function(){
	mytable("#f5f5f5","#fff","#def2fa","#def2fa");
});
</script>
<!-- 导航栏 -->
