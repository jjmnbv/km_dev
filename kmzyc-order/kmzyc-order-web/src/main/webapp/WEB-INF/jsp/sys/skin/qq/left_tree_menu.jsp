...
html { scrollbar-face-color: #A4DDFF; scrollbar-highlight-color: #AAE8FD; scrollbar-shadow-color: #0095E1; scrollbar-3dlight-color: #0095E1; scrollbar-arrow-color: #02338A; scrollbar-track-color: #C8EBF7; scrollbar-darkshadow-color: #C8EBF7; overflow-x: hidden; overflow-y: auto; margin: 0px; padding: 0px; }
-->
</style>
</head>
...
<div class="menubox">
  <div class="menuTitle">
    <div class="menuico" style="cursor: hand" onclick="showmenu('ff<%=menu.getMenuId()%>',image<%=menu.getMenuId()%>);"> <img src="/etc/images/sys/menu_on.png" id="image<%=menu.getMenuId()%>" name="image<%=menu.getMenuId()%>" onclick="return false;" /> </div>
    <div class="menutext">
