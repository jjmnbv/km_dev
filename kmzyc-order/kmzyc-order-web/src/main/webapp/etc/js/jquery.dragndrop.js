    ...
    $.fn.Drags = function(opts) {
        ...
        var dragndrop = {
            ...
            drop: function(e) {
                ...
                dragData.onDrop(e);
                $("#"+dragData.handler[0].id).unbind('mousemove', dragndrop.drag)
        ...
        return this.each(function() {
            ...
            handler.bind('mousedown', { e: me }, function(s) {
               ...
               // target.css('opacity', ps.opacity);
                $("#"+handler[0].id).bind('mousemove', { dragData: dragData }, dragndrop.drag);
                $("#"+handler[0].id).bind('mouseup', { dragData: dragData }, dragndrop.drop);
            });
