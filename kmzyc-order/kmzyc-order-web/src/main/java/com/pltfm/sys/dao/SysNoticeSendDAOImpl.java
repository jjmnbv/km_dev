...
public class SysNoticeSendDAOImpl implements SysNoticeSendDAO {
  ...
  public int countByExample(SysNoticeSendExample example) throws SQLException {
    Integer count =
        (Integer) sqlMapClient.queryForObject("sys_notice_send.ibatorgenerated_countByExample",
            example);
    return count;
  }
  ...
  public SysNoticeSend selectByPrimaryKey(SysNoticeSendKey key) throws SQLException {
    SysNoticeSend record =
        (SysNoticeSend) sqlMapClient.queryForObject(
            "sys_notice_send.ibatorgenerated_selectByPrimaryKey", key);
    return record;
  }
