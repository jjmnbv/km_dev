...
public class SysRole implements Serializable {
  ...
  /**
   * This method was generated by Apache iBATIS ibator. This method returns the value of the
   * database column SYS_ROLE.ROLE_EXPLAIN
   * 
  ...
  /**
   * This method was generated by Apache iBATIS ibator. This method returns the value of the
   * database column SYS_ROLE.ROLE_REMARK
   * 
  ...
  public boolean equals(Object that) {
    ...
    return this.getRoleId() == null ? other == null : this.getRoleId().equals(other.getRoleId())
        && this.getRoleName() == null ? other == null : this.getRoleName().equals(
        other.getRoleName())
        && this.getRoleExplain() == null ? other == null : this.getRoleExplain().equals(
        other.getRoleExplain())
        && this.getRoleRemark() == null ? other == null : this.getRoleRemark().equals(
        other.getRoleRemark());
  }
