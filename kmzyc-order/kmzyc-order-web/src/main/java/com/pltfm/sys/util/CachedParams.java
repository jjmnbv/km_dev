...
public class CachedParams {
   ...
   * @return Map
   */
  // private static Map<String,String> loadParamList(String sysCd,String
  // paramGp) {
  ...
  // hm.put( ((SysParam)paramList.get(i)).getParamValue(),
  // ((SysParam)paramList.get(i)).getParamName());
  // }
  // //set in cache
  ...
  // public static Map<String,String> getParamListByCd(String sysCd,String
  // paramGp) {
  // String paraStr = sysCd + "#" + paramGp;
