...
public class TreeNode implements Serializable {
   ...
   * @return
   */
  public static boolean appendAsChild(TreeNode childNode, TreeNode toBeAppended) {
   ...
   * @return
   */
  public static boolean appendAsSubling(TreeNode sublingNode, TreeNode toBeAppended) {
