...
public class WxPayHelper {
  ...
  private Boolean CheckCftParameters() {
    if (Objects.equals(parameters.get("bank_type"), "") ||
            Objects.equals(parameters.get("body"), "")
        || Objects.equals(parameters.get("partner"), "") ||
            Objects.equals(parameters.get("out_trade_no"), "")
        || Objects.equals(parameters.get("total_fee"), "") ||
            Objects.equals(parameters.get("fee_type"), "")
        || parameters.get("notify_url") == null ||
            Objects.equals(parameters.get("spbill_create_ip"), "")
        || Objects.equals(parameters.get("input_charset"), "")) {
      return false;
    }
    return true;
  }
  ...
  public String GetCftPackage() throws SDKRuntimeException {
    if (Strings.isNullOrEmpty(PartnerKey)) {
  ...
  // 生成jsapi支付请求json
  /*
   * "appId" : "wxf8b4f85f3a794e77", //公众号名称，由商户传入 "timeStamp" : "189026618", //时间戳这里随意使用了一个值
   ...
   * p=127.0.0.1&total_fee=1&sign=BEEF37AD19575D92E191C1E4B1474CA9", //扩展字段，由商户传入 "signType" :
   * "SHA1", //微信签名方式:sha1 "paySign" : "7717231c335a05165b1874658306fa431fe9a0de" //微信签名
   */
   ...
   * <Package><![CDATA[a=1&url=http%3A%2F%2Fwww.qq.com]]></Package> <TimeStamp>
   * 1369745073</TimeStamp> <NonceStr><![CDATA[iuytxA0cH6PyTAVISB28]]></NonceStr>
   * <RetCode>0</RetCode> <RetErrMsg><![CDATA[ok]]></ RetErrMsg>
   * <AppSignature><![CDATA[53cca9d47b883bd4a5c85a9300df3da0cb48565c]]> </AppSignature>
  ...
  public String CreateNativePackage(String retcode, String reterrmsg) throws SDKRuntimeException {
    HashMap<String, String> nativeObj = new HashMap<String, String>();
    if (CheckCftParameters() == false && Objects.equals(retcode, "0")) {
      throw new SDKRuntimeException("生成package参数缺失！");
    }
    nativeObj.put("AppId", AppId);
    nativeObj.put("Package", GetCftPackage());
