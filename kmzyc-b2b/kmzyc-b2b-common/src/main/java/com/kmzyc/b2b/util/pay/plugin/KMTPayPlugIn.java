...
public class KMTPayPlugIn extends BasePayPlugIn {
    private static Logger log = LoggerFactory.getLogger(KMTPayPlugIn.class);
    // 支付
    // private static final String payUrl = ConfigurationUtil.getString("kmt_pay_url");
    // 退款
    // private static final String refundUrl = ConfigurationUtil.getString("kmt_refund_req_url");
    ...
    public String onPay() throws Exception {
        ...
        if (null != order && !StringUtil.isEmpty(order.getOrderCode())) {
            // 支付
            Map<String, String> requestMap = genKMTPayMap(order, this.getCallBackRequest());
            return PaymentUtil.buildKMTPayRequest(requestMap,
                    ConfigurationUtil.getString("kmt_pay_url"), "post", "确定");
        }
        return null;
    }
     ...
     * @return
     */
    private Map<String, String> genKMTPayMap(PayCommonObject order,
        ...
        requestMap.put("partner", ConfigurationUtil.getString("kmt_pay_partner"));// 商户号
        requestMap.put("outTradeNo", order.getOrderCode());// 商家订单号
        requestMap.put("sellerEmail", ConfigurationUtil.getString("kmt_seller_email"));// 卖家账号
        ...
        String notifyUrl = ConfigurationUtil.getString("kmt_pay_callback_url");
        ...
        requestMap.put("returnUrl", "http://www.kmb2b.com/member/queryOrderList.action?t="
