...
public class RegistedInfo implements Serializable {
  ...
  private int mobileValidPoint; // 手机验证积分

  public int getMobileValidPoint() {
    return mobileValidPoint;
  }

  public void setMobileValidPoint(int mobileValidPoint) {
    this.mobileValidPoint = mobileValidPoint;
  }
