...
<meta name="Description" content="" />
 <jsp:include page="/WEB-INF/jsp/common/wapTemplate.jsp">
    	<jsp:param name="titlePrefix" value="支付管理修改成功"></jsp:param>
    </jsp:include>
</head>
<body class="l-w1000">
<!--头部LOGO及搜索-->
...
<jsp:include page="/html/common/wap/portal-head.jsp">
	   <jsp:param name="pageTitle" value="支付管理修改成功"></jsp:param>
</jsp:include> 
<tiles:insertDefinition name="postWapPaySettingContent" />
<!--底部-->
