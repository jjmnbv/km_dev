package com.kmzyc.b2b.weibo.http;
...
import com.kmzyc.b2b.weibo.model.Configuration;
import com.kmzyc.b2b.weibo.model.MySSLSocketFactory;
import com.kmzyc.b2b.weibo.model.Paging;
...
public class HttpClient implements java.io.Serializable {
  ...
  public Response multPartURL(String fileParamName, String url, PostParameter[] params, File file,
    ...
    try {
      ...
      FilePart filePart =
          new FilePart(fileParamName, file.getName(), file,
  ...
  public Response httpRequest(HttpMethod method, Boolean WithTokenHeader) throws WeiboException {
    ...
    try {
      ...
      {
        try {
          throw new WeiboException(getCause(responseCode), response.asJSONObject(),
