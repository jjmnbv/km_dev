...
import com.kmzyc.b2b.weibo.json.JSONArray;
...
public class Users extends Weibo {
    ...
    public User showUserById(String uid) throws WeiboException {
        return new User(client.get(ConfigurationUtil.getString("sina_baseURL") + "users/show.json",
    ...
    public User showUserByDomain(String domain) throws WeiboException {
        return new User(client.get(
                ConfigurationUtil.getString("sina_baseURL") + "users/domain_show.json",
    ...
    public JSONArray getUserCount(String uids) throws WeiboException {
        return client.get(ConfigurationUtil.getString("sina_baseURL") + "users/counts.json",
