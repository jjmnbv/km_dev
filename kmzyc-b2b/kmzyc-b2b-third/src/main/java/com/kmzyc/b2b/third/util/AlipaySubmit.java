...
import com.kmzyc.b2b.util.httpClient.HttpResultType;
...
public class AlipaySubmit {
    ...
    public static String buildRequestMysign(Map<String, String> sPara) {
        ...
        String mysign = "";
        if (ConfigurationUtil.getString("alipay_sign_type").equals("MD5")) {
            mysign =
                    MD5.sign(prestr, ConfigurationUtil.getString("alipay_key"),
                            ConfigurationUtil.getString("alipay_input_charset"));
        }
        return mysign;
    }
    ...
    public static Map<String, String> buildRequestPara(Map<String, String> sParaTemp) {
        ...
        sPara.put("sign_type", ConfigurationUtil.getString("alipay_sign_type"));
    ...
    public static String buildRequest(Map<String, String> sParaTemp, String strMethod,
        ...
        sbHtml.append("<html><head></head><body><form id=\"alipaysubmit\" name=\"alipaysubmit\" action=\""
                + ALIPAY_GATEWAY_NEW
                + "_input_charset="
                + ConfigurationUtil.getString("alipay_input_charset")
                + "\" method=\""
        ...
        sbHtml.append("<script>window.onload = function(){document.forms['alipaysubmit'].submit();};</script></body></html>");
    ...
    public static String buildRequest(String strParaFileName, String strFilePath,
        ...
        // 设置编码集
        request.setCharset(ConfigurationUtil.getString("alipay_input_charset"));
    ...
    public static String query_timestamp() throws MalformedURLException, DocumentException,
        ...
        String strUrl =
                ALIPAY_GATEWAY_NEW + "service=query_timestamp&partner="
                        + ConfigurationUtil.getString("alipay_partner") + "&_input_charset"
                        + ConfigurationUtil.getString("alipay_input_charset");
