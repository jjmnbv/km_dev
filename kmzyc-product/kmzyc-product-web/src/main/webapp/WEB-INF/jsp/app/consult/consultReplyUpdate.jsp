...
<s:set name="son_name" value="'咨询回复修改'" scope="request" />
<jsp:include page="/WEB-INF/jsp/common/title.jsp"></jsp:include>
<body>
	<s:form name="consultForm" method="post" action="/app/replyConsultUpdate.action">
    ...
    <input type="hidden"  name="searchConsut.consultId"  value="<s:property value='searchConsut.consultId'/>"    />
		...
		<table width="61%" height="252" border="1" align="left" cellpadding="3"
			...
			<tr>
				...
				<tr>
			      ...
			      <textarea name="searchConsut.replyContent" id="textarea" cols="45" rows="5"><s:property value="searchConsut.replyContent"></s:property></textarea></td>
		  </tr>
		</table>
        <table width="1025" height="50" border="0" align="center" style="float: left; position: absolute; top: 320px;">
			<tr>
					...
					<td width="653" align="left"><input type="submit" name="button"  class="btnStyle"    id="button" value="回复修改">
