...
<body>
	...
	<s:form action="updateSupplierShop.action" namespace="app" name="frm1" method="post" enctype="multipart/form-data"
		id="frm">

	 	<input name="showShopMainDraft.shopId"
			type="hidden" value="<s:property value='showShopMainDraft.shopId'/>" />
			<input type="hidden" name="shopId" value="<s:property value='showShopMainDraft.shopId'/>"></input>
		<!-- 数据编辑区域 -->
		...
		<table width="95%" class="edit_table" align="center" cellpadding="3"
			...
			<tr>
				...
				<td><s:property value="showShopMainDraft.shopName" />
				</td>
			</tr>
			<tr>
				<th align="right" class="eidt_rowTitle">店铺标题：</th>
				<td><s:property value="showShopMainDraft.shopTitle" />
				</td>
			</tr>
		<!--  	<tr>
				<th align="right" class="eidt_rowTitle">店铺LOGO：</th>
				<td>
				<img width="142px" height="50px" src="${imagePaths}${showShopMainDraft.logoPath}">
				</td>
			</tr>
			<tr>
				<th align="right" class="eidt_rowTitle">店铺展示图片：</th>
				<td>
				<img width="300px" height="199px" src="${imagePaths}${showShopMainDraft.filePath}">
				</td>
			</tr>-->
				<tr>
			...
			<!--<tr>
				...
				<td><input type="file" name="showShopMainDraft.filePath"></iput>
				  <input class="input_style" name="prodSupplier.address" size="60"
					type="text" value="<s:property value="showShopMainDraft.filePath" />" />
				</td>
			</tr>-->
			<tr>
				<th align="right" class="eidt_rowTitle">店铺SEO：</th>
				<td><s:property value="showShopMainDraft.shopSeoKey" />
				</td>
			</tr>
			<!--  <tr>
				<th width="20%" align="right" class="eidt_rowTitle">联系方式：</th>
				<td width="80%"><s:property value="showShopMainDraft.contactInfo" /></td>
			</tr>-->

			<tr>
				<th width="20%" class="eidt_rowTitle" align="right">店铺简介：</th>
				<td width="80%">
				<s:property value="showShopMainDraft.introduce"  />
				</td>
			</tr>
			<%--  <tr>
				<th align="right" class="eidt_rowTitle">详细描述：</th>
				<td><input class="input_style" name="showShopMainDraft.shopName"
					type="text"
					value="<s:property value="prodSupplier.companyScale"  />" /></td>
			</tr>
			<tr>
				<th align="right" class="eidt_rowTitle">店铺级别：</th>
				<td><s:property value="showShopMainDraft.shopLevel" /></td>
			</tr>
			<tr>
				<th align="right" class="eidt_rowTitle">店铺站点：</th>
				<td><s:property value="showShopMainDraft.shopSite" /></td>
			</tr>--%>
		</table>
		...
		<table width="98%" align="center" class="edit_bottom" height="30"
			...
			<tr>
				<td align="center"> <input type="button" class="backBtn"
					onclick="gotoList()" />
     ...
     <input type="hidden"  name="pageNum"  value="<s:property value='pageNum' />"   />
      <input type="hidden"  name="searchShopMainDraft.shopCode"  value="<s:property value='searchShopMainDraft.shopCode' />"   />
