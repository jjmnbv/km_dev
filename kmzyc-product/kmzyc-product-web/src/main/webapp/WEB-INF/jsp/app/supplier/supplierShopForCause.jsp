...
<body onkeydown="changeKey();">
		<!-- 数据编辑区域 -->
		<table width="95%" class="edit_table" align="center" width="400px" height="200px" cellpadding="3"
			cellspacing="0" border="1" bordercolor="#C7D3E2"
			style="border-collapse: collapse; font-size: 12px;">
			 <input type="hidden"  name="shopId"  id="shopId" value="<s:property value='shopId' />"   />
			<tr>
	...
	<SCRIPT LANGUAGE="JavaScript">
		...
		function batchAuditSupplier(){
			...
			if("" == texts){
			 ...
			 $.ajax({
	             url: 'auditSupplierShop.action',
	             async:false,
	             data: 'describe='+encodeURI(encodeURI(texts))+'&shopId='+shopId,
