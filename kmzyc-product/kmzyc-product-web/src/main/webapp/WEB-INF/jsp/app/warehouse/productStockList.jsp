...
<s:set name="name" value="'库存列表'" scope="request" />
<jsp:include page="/WEB-INF/jsp/common/title.jsp"></jsp:include>

<s:form action="/app/stockShow.action" method="POST"  namespace='/app' id="frm" name='frm'>
...
<table  width="98%" class="content_table" align="center" cellpadding="0" cellspacing="0" >
	...
	<tr>
	  ...
	  <td>产品标题：
	    <s:textfield name="stockForSelectPara.product.productTitle" cssClass="input_style" id="productTitle" /></td>
	  <td>产品编码：
...
<table width="98%" class="list_table" align="center" cellpadding="3" cellspacing="0" border="1" bordercolor="#C1C8D2">
	<tr>
		...
		<th align="center" width="16%">SKU描述</th>
	...
	<tr>
		...
		<td align="center">
			<s:iterator value="skuAttrList" var="v" >
				<b><s:property value="#v.categoryAttrName" /></b>：<s:property value="#v.categoryAttrValue" />&nbsp;&nbsp;
			</s:iterator>
		 </td>		
		<td align="center"><s:property value="stockQuality" /></td>
		...
		<td align="center">
			...
			<img title="查看" style="cursor: pointer;" src="/etc/images/button_new/search.png"  onclick="gotoViewStock(<s:property value='stockId'/>)" />		</td>
	</tr>
	</s:iterator>
</table>
