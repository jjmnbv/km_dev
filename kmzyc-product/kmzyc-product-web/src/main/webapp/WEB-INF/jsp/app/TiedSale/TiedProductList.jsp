...
<body>
	...
	<s:set name="son_name" value="'产品搭售列表'" scope="request" />
	<jsp:include page="/WEB-INF/jsp/common/title.jsp"></jsp:include>


	<s:form action="/tiedSale/tiedSaleShow.action" method="POST"
		...
		<table width="98%" class="content_table" align="center" height="100"
			...
			<tr>
				<td>品牌：&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<s:select list="#request.productBrandMap" id="brandId"
						  headerKey="0"   style="width:116px    "  
						name="product.brandId" headerValue="--全部品牌--"></s:select>
				</td>
				<td><INPUT   type="submit"   class="queryBtn"
					value="">
				</td>
			</tr>
		</table>
...
location.href="/tiedSale/tiedSaleAdd.action?product.productSkuId="+mainSku;
}
