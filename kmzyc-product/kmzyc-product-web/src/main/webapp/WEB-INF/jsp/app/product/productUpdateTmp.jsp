...
<body>
<s:form action="/app/productUpdate.action" method="POST"
	namespace='/app' onsubmit="return Validator.Validate(this,2)&&checkSelected()">
	...
	<table width="95%" class="edit_table" align="center" cellpadding="3"
		...
		<tr>
			<th width="20%" align="right"><font color="red">*</font>产品类别：</th>
			<td width="80%"><s:select list="#request.categoryList"
				id="categoryId1" listKey="categoryId" listValue="categoryName"
		...
		<tr>
			<th align="right"><font color="red">*</font>品牌：</th>
			<td><label><s:select list="#request.productBrandMap"
				name="product.brandId" id="brandId" headerKey=""
				headerValue="--产品品牌--"></s:select></label></td>
		</tr>
		<tr>
			<th align="right"><font color="red">*</font>产品名称：</th>
		...
		<tr>
			...
			<td><s:textfield name="product.productNo" id="productNo"
				size="32" maxlength="32" /></td>
		</tr>
		<tr>
			<th align="right">产品标题：</th>
			<td><s:textfield name="product.productTitle" id="productTitle"
				size="32" maxlength="512" /></td>
		</tr>
		<tr>
			<th align="right">关键词(seo)：</th>
			<td><s:textfield name="product.keyword" id="keyword" size="32"
				maxlength="32" /></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><label> <s:textarea name="product.productDesc"
				id="productDesc" rows="8" cols="45" /></label></td>
		</tr>
	</table>
