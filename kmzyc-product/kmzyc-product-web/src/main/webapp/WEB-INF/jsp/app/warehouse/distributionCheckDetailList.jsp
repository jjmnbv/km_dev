...
<s:set name="name" value="'配送单审核细目列表'" scope="request" />
<jsp:include page="/WEB-INF/jsp/common/title.jsp"></jsp:include>

	
<s:form action="toDistributionDetails" method="post"  namespace='/app' id="distributionInfofrm" name='distributionInfofrm'>
	<input id="distributionId" type="hidden" value="<s:property value='distributionId'/>" name="distributionId" />
	<input id="showType" type="hidden" value="checkList" name="showType" />
<table  width="98%" class="content_table" align="center" height="100" cellpadding="0" cellspacing="0" >		
	...
	<tr>
     ...
     <tr>
	  <td width="10%"><strong>业务单据:</strong><s:property value="distributionInfo.billNo"/> </td>
...
<table  width="98%" align="center" cellpadding="0" cellspacing="0">
	...
	<table width="98%" align="center" class="edit_bottom" height="30"
		...
		<tr>
			<td align="center">
				<input type="button" class="btn-custom btnStyle" value="返回" onClick="todistributionInfoCheckDetail();" />
		    </td>
		</tr>
	</table>
	<br/> 	<br/>
