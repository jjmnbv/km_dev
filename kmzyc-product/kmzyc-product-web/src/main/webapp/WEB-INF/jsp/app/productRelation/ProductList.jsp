...
<s:form action="/productRelation/skuProductQuery.action" method="POST" namespace="productRelation" id="frm" name='frm'>
    ...
    <table width="98%" class="content_table" align="center" height="100" cellpadding="0" cellspacing="0">
        ...
        <tr>
            ...
            <td>关键字：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <s:textfield type="text" cssClass="input_style" name="productTied.keyword" id="keyword"/>
            </td>
            <td></td>
        </tr>
        <tr>
            <td> 品牌： &nbsp;&nbsp;&nbsp;&nbsp;
                <s:select list="#request.productBrandMap" id="brandId" headerKey="" style="width:143px"
                          name="productTied.brandId" headerValue="--全部品牌--">
                </s:select>
            </td>
            <td>产品SKU编号：<s:textfield type="text" cssClass="input_style" name="productTied.productSkuCode" /></td>
            <td>
...
<script type="text/javascript">
    ...
    function queryRelationPackage(mainId) {
        $('#frm').attr("action", '/productRelation/queryPackage.action?productRelation.mainSkuId=' + mainId);
        $('#frm').submit();
    }
