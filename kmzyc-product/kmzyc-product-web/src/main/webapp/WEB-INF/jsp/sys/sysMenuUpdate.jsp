	...
	<table width="95%" class="tableInput1" align="center" cellpadding="3" cellspacing="0" border="1" bordercolor="#C7D3E2" style="border-collapse: collapse">
		...
		<tr>
			<td colspan="2" align="center">
				...
				<input type="button" class="btngreen"  style="height:30px" value=" 删除" onClick="deleteThisClass();"/>&nbsp;&nbsp;&nbsp;&nbsp;
				<input type="button" class="btngreen"  style="height:30px" value=" 新增下级菜单" onClick="addSonClass();"/>
			</td>
		</tr>
	</table>
