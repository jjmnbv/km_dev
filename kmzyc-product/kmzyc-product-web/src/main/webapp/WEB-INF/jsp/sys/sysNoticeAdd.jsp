...
<table width="98%" align="center" class="topbuttonbar" height="30" border="0" cellpadding="0" cellspacing="0">
	<tr> 
	    <td width="90%" valign="middle">
            <INPUT class="btngreen" TYPE="button" style="height:30px" value=" 保存并发送 " onClick="saveAndSend()">
			<INPUT class="btngreen" TYPE="button" style="height:30px" value="存为草稿" onClick="saveDraft()">
		</td>
