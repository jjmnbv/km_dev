...
#leftMenu { padding: 0px; margin: 0px; background: #E1F3E7; }
    ...
    <div id="leftMenu" width="100%" >
      <div style="background: #336699; width:160px;border-bottom:1px solid #079346;height: 40px; padding-left: 10px; text-align: left; line-height: 35px; color: #fff; font-size: 15px;"> <span style="font-size:14px;font-weight:bold;color:#028043;"> <img src="/etc/images/sys/icon_01.png"  style="width:25px;height:25px;vertical-align: middle;">&nbsp;
