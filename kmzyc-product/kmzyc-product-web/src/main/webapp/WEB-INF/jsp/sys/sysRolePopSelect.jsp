...
%>
	<tr>
	    <td align="center">
		    <input type="checkbox" <%=ifReadOnly%> name="delId" value='<s:property value="roleId"/>'  dataValue='<s:property value="roleName"/>'>
		</td>
...
function selectList() {
	...
	{   
		...
		{   
				 ...
				 nameStr = nameStr + roleIds[i].getAttribute("dataValue") + ",";
		}
	}
	if(idStr == ""){
        alert("没有选中任何岗位角色！");
