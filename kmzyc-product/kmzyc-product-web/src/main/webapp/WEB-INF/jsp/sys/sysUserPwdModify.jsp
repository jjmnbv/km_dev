...
<s:if test='rtnMessage.equals("updateFalse")'>
    ...
    //-->
		...
		<!-- 导航栏 -->
		<s:set name="parent_name" value="'系统设置'" scope="request" />
		<s:set name="name" value="'修改密码'" scope="request" />
		<jsp:include page="/WEB-INF/jsp/common/title.jsp"></jsp:include>

<!-- 数据编辑区域 -->
<table width="98%" class="tableInput1" align="center" cellpadding="3" cellspacing="0" border="1" bordercolor="#C7D3E2" style="border-collapse: collapse; margin-left:20px;">
	<tr>
...
<table width="98%" align="center" class="bottombuttonbar" height="30" border="0" cellpadding="0" cellspacing="0">
	<tr> 
		<td width="90%" valign="middle" style="text-align:center;">
			<INPUT class="btn-custom" TYPE="submit" style="height:30px" value=" 保存 " style="width:70px; height:30px; cursor: pointer;">
		</td>
