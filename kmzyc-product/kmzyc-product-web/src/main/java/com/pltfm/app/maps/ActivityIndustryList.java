 ...
 * 
 */
public class ActivityIndustryList {
	private static final Logger log = LoggerFactory.getLogger(ActivityIndustryList.class);
		...
		try {
			if (list == null) {
				...
				p.load(Thread.currentThread().getContextClassLoader()
						.getResourceAsStream("/config/activity_industry.properties"));
