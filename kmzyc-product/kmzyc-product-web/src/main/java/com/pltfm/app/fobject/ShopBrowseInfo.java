...
public class ShopBrowseInfo implements Serializable{
	...
	private String supplierNameForQuery;
	...
	public String getSupplierNameForQuery() {
		return supplierNameForQuery;
	}

	public void setSupplierNameForQuery(String supplierNameForQuery) {
		this.supplierNameForQuery = supplierNameForQuery;
	}
