...
public class ReportColumnSettingDAOImpl implements ReportColumnSettingDAO {
    ...
    public int countByExample(ReportColumnSettingExample example) throws SQLException {
        Integer count = (Integer)  sqlMapClient.queryForObject("report_column_setting.ibatorgenerated_countByExample", example);
        return count;
    }
    ...
    public int deleteByExample(ReportColumnSettingExample example) throws SQLException {
        int rows = sqlMapClient.delete("report_column_setting.ibatorgenerated_deleteByExample", example);
        return rows;
    }
    ...
    public Integer insertSelective(ReportColumnSetting record) throws SQLException {
        Object newKey = sqlMapClient.insert("report_column_setting.ibatorgenerated_insertSelective", record);
        return (Integer) newKey;
    }
    ...
    public List<ReportColumnSetting> selectByExample(ReportColumnSettingExample example) throws SQLException {
        List<ReportColumnSetting> list = sqlMapClient.queryForList("report_column_setting.ibatorgenerated_selectByExample", example);
        return list;
    }
    ...
    public ReportColumnSetting selectByPrimaryKey(Integer colId) throws SQLException {
        ReportColumnSetting key = new ReportColumnSetting();
        key.setColId(colId);
        ReportColumnSetting record = (ReportColumnSetting) sqlMapClient.queryForObject("report_column_setting.ibatorgenerated_selectByPrimaryKey", key);
        return record;
    }
     ...
     * @ibatorgenerated Wed Mar 10 14:42:57 CST 2010
     */
    public int updateByExampleSelective(ReportColumnSetting record, ReportColumnSettingExample example) throws SQLException {
        UpdateByExampleParms parms = new UpdateByExampleParms(record, example);
        int rows = sqlMapClient.update("report_column_setting.ibatorgenerated_updateByExampleSelective", parms);
        return rows;
    }
     ...
     * @ibatorgenerated Wed Mar 10 14:42:57 CST 2010
     */
    public int updateByExample(ReportColumnSetting record, ReportColumnSettingExample example) throws SQLException {
        UpdateByExampleParms parms = new UpdateByExampleParms(record, example);
    ...
    public int updateByPrimaryKeySelective(ReportColumnSetting record) throws SQLException {
        int rows = sqlMapClient.update("report_column_setting.ibatorgenerated_updateByPrimaryKeySelective", record);
        return rows;
    }
    ...
    public int updateByPrimaryKey(ReportColumnSetting record) throws SQLException {
        int rows = sqlMapClient.update("report_column_setting.ibatorgenerated_updateByPrimaryKey", record);
        return rows;
    }
