...
public class DatetimeUtil
{
    ...
    public static java.util.Date changeToDate(String _dateStr, String _pattern)
    {
        ...
        {
            throw new java.lang.IllegalArgumentException("不能使用模式:[" + _pattern +
                "]格式化时间串:[" + _dateStr + "]");
        }
    ...
    {
        return getCurMonthFirstDay(new java.util.Date(
    ...
    public static String getCurMonthLastDay(java.util.Date date)
    {
        ...
        java.util.Date currentMonthFirstDayDate = changeToDate(formatDate(
    ...
    {
        return getLastMonthFirstDay(new java.util.Date(
            System.currentTimeMillis()));
    }
    ...
    {
        return getLastMonthLastDay(new java.util.Date(
            System.currentTimeMillis()));
    }
     ...
     */
    public static int getMonthCount(java.util.Date _startDate,
                                    java.util.Date _endDate)
    {
        ...
        int startYear = calendar.get(Calendar.YEAR);
        int countDayOfStartMonth = calendar.getActualMaximum(Calendar.
            DAY_OF_MONTH);
        calendar.clear();
        ...
        int result = ((endYear - startYear) * 12) +
            ...
            (int)((endDay + (countDayOfStartMonth - startDay)) /
                  countDayOfStartMonth);
    ...
    {
        java.sql.Timestamp sdate = new java.sql.Timestamp(System.
            currentTimeMillis());
