...
public class ViewProductSkuAndStock implements java.io.Serializable {
	...
	public String toString() {
		return "ViewProductSkuAndStock [productId=" + productId
				+ ", procuctName=" + procuctName + ", productNo=" + productNo
				+ ", status=" + status + ", channel=" + channel
				+ ", marketPrice=" + marketPrice + ", costPrice=" + costPrice
				+ ", categoryId=" + categoryId + ", categoryName="
				+ categoryName + ", productSkuId=" + productSkuId
				+ ", productSkuCode=" + productSkuCode + ", skuStatus="
				+ skuStatus + ", price=" + price + ", viewSkuAttrs="
				+ viewSkuAttrs + ", stockQuality=" + stockQuality + "]";
	}
