...
public class StockOutAftersaleReturn implements java.io.Serializable {
	...
	public String toString() {
		return "StockOutAftersaleReturn [stockOutId=" + stockOutId
				+ ", customerTypeId=" + customerTypeId + ", stockOutNo="
				+ stockOutNo + ", warehouseId=" + warehouseId + ", type="
				+ type + ", userId=" + userId + ", userName=" + userName
				+ ", totalQuantity=" + totalQuantity + ", taxSum=" + taxSum
				+ ", totalTax=" + totalTax + ", totalSum=" + totalSum
				+ ", createUser=" + createUser + ", createUserName="
				+ createUserName + ", createDate=" + createDate
				+ ", auditUser=" + auditUser + ", checkUserName="
				+ checkUserName + ", auditDate=" + auditDate + ", status="
				+ status + ", dayEndStatus=" + dayEndStatus + ", remark="
				+ remark + ", billNo=" + billNo + ", modifiyDate="
				+ modifiyDate + ", modifierId=" + modifierId
				+ ", modifierName=" + modifierName + ", returnNo=" + returnNo
				+ ", custId=" + custId + ", custName=" + custName
				+ ", shipAddress=" + shipAddress + ", linkPhone=" + linkPhone
				+ "]";
	}
