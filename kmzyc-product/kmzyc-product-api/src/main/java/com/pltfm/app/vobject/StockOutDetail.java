...
public class StockOutDetail implements Serializable {
	...
	public String toString() {
		return "StockOutDetail [detailId=" + detailId + ", stockOutId="
				+ stockOutId + ", stockId=" + stockId + ", productId="
				+ productId + ", productName=" + productName + ", productNo="
				+ productNo + ", productSkuId=" + productSkuId
				+ ", productSkuValue=" + productSkuValue + ", barCode="
				+ barCode + ", billDetailId=" + billDetailId + ", billType="
				+ billType + ", quantity=" + quantity + ", taxPrice="
				+ taxPrice + ", taxSum=" + taxSum + ", taxRate=" + taxRate
				+ ", tax=" + tax + ", price=" + price + ", sum=" + sum
				+ ", remark=" + remark + "]";
	}
