...
public class SysMenuDAOImpl implements SysMenuDAO {
    private static SysMenuDAOImpl instance;

    public static SysMenuDAOImpl instance(SqlMapClient sqlMapClient){
        if(instance==null)
            instance=new SysMenuDAOImpl(sqlMapClient);
        return instance;
    }
    /**
     ...
     * @ibatorgenerated Thu Nov 24 14:28:04 CST 2011
     */
    private SysMenuDAOImpl(SqlMapClient sqlMapClient) {
        super();
    ...
    /******************* select header menu  by userId **********************************/
    public List selectUpMenuByUser(Integer userId) throws SQLException {
        SysUser key = new SysUser();
        key.setUserId(userId);
        List list = sqlMapClient.queryForList("SYS_MENU.selectUpMenuByUser", key);
        return list;
    }
