...
public class SysLogDAOImpl implements SysLogDAO {
    private static SysLogDAOImpl instance;

    public static SysLogDAOImpl instance(SqlMapClient sqlMapClient){
        if(instance==null)
            instance=new SysLogDAOImpl(sqlMapClient);
        return instance;
    }
    /**
     ...
     * @ibatorgenerated Thu Nov 24 14:28:04 CST 2011
     */
    private SysLogDAOImpl(SqlMapClient sqlMapClient) {
        super();
    ...
    public int countByExample(SysLogExample example) throws SQLException {
        Integer count = (Integer) sqlMapClient.queryForObject("SYS_LOG.ibatorgenerated_countByExample", example);
        return count;
    }
    ...
    public List<SysLog> selectByExample(SysLogExample example) throws SQLException {
        List<SysLog> list = sqlMapClient.queryForList("SYS_LOG.ibatorgenerated_selectByExample", example);
        return list;
    }
    ...
    public SysLog selectByPrimaryKey(Integer syslogId) throws SQLException {
        SysLog key = new SysLog();
        key.setSyslogId(syslogId);
        SysLog record = (SysLog) sqlMapClient.queryForObject("SYS_LOG.ibatorgenerated_selectByPrimaryKey", key);
        return record;
    }
    ...
    public Page selectPageByVo(Page page, SysLog vo) throws SQLException {
        SysModelUtil countResult = (SysModelUtil) sqlMapClient.queryForObject("SYS_LOG.getSysLogCount", vo);
