...
public class StringUtil {
    ...
    public synchronized static final String hash(String data) {
        if (digest == null) {
            try {
                ...
                logger.error("异常：" + nsae.getMessage(), nsae);
            }
        }
        // Now, compute hash.
    ...
    public static final byte[] hexToBytes(String hex) {
        ...
        try {
        	...
        	logger.error("StringUtil.hexToBytes异常：" + e.getMessage(), e);
            return new byte[0];
        }
     ...
     *
     * @param src        src 源字符串
     * @param beginIndex beginIndex 起始位置,0为第一位
     * @param endIndex   endIndex 终止位置,1为第一位
     * @return String
     * @auth LBL
     * @since 2002.11.27
     */
     ...
     *
     * @param src        源字符串
     * @param beginIndex 起始位置,0为第一位
     * @param endIndex   终止位置,1为第一位
     * @param ifAdd      ==true 如果最后是半个汉字，返回长度加一 ==false 如果最后是半个汉字，返回长度减一
     * @return String
     * @auth LBL
     * @since 2002.11.27
     */
     ...
     * @param src        源字符串
     * @param beginIndex 起始位置,0为第一位
     * @param endIndex   终止位置,1为第一位 如果最后是半个汉字，返回长度减一
     * @return String
     * @auth LBL
     * @since 2002.11.27
     */
