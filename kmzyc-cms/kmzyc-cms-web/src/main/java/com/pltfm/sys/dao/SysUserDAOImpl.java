...
public class SysUserDAOImpl implements SysUserDAO {
    private static SysUserDAOImpl instance;

    public static SysUserDAOImpl instance(SqlMapClient sqlMapClient){
        if(instance==null)
            instance=new SysUserDAOImpl(sqlMapClient);
        return instance;
    }
    /**
     ...
     * @ibatorgenerated Thu Nov 24 14:28:04 CST 2011
     */
    private SysUserDAOImpl(SqlMapClient sqlMapClient) {
        super();
    ...
    public int countByExample(SysUserExample example) throws SQLException {
        Integer count = (Integer) sqlMapClient.queryForObject("SYS_USER.ibatorgenerated_countByExample", example);
        return count;
    }
    ...
    public List<SysUser> selectByExample(SysUserExample example) throws SQLException {
        List<SysUser> list = sqlMapClient.queryForList("SYS_USER.ibatorgenerated_selectByExample", example);
        return list;
    }

    @SuppressWarnings("unchecked")
    public List<SysUserRole> selectByUser(SysUser example) throws SQLException {
        List<SysUserRole> list = sqlMapClient.queryForList("SYS_USER_ROLE.ibatorgenerated_selectByUserId", example);
        return list;
    }
    ...
    public SysUser selectByPrimaryKey(Integer userId) throws SQLException {
        SysUser key = new SysUser();
        key.setUserId(userId);
        SysUser record = (SysUser) sqlMapClient.queryForObject("SYS_USER.ibatorgenerated_selectByPrimaryKey", key);
        return record;
    }
    ...
    public Page selectPageByVo(Page page, SysUser vo) throws SQLException {
        ...
        SysModelUtil countResult = (SysModelUtil) sqlMapClient.queryForObject("SYS_USER.getSysUserCount", vo);
