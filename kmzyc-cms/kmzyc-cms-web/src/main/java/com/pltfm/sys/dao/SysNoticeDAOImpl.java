...
public class SysNoticeDAOImpl implements SysNoticeDAO {
    private static SysNoticeDAOImpl instance;

    public static SysNoticeDAOImpl instance(SqlMapClient sqlMapClient){
        if(instance==null)
            instance=new SysNoticeDAOImpl(sqlMapClient);
        return instance;
    }
    /**
     ...
     * @ibatorgenerated Wed Jan 27 15:44:06 CST 2010
     */
    private SysNoticeDAOImpl(SqlMapClient sqlMapClient) {
        super();
