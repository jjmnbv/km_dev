...
public class JDomUtil {
    ...
    public static Document getDocument(String xmlString) {
        try {
        	...
        	logger.error("JDomUtil.getDocument异常：" + e.getMessage(), e);
        }
        return null;
    }
    ...
    public static Document getDocumentByURL(String urlStr) {
        try {
            ...
            logger.error("JDomUtil.getDocumentByURL异常：" + e.getMessage(), e);
        }
        return null;
    }
    ...
    public static Document getDocumentByFile(String fileName) {
        try {
            ...
            logger.error("JDomUtil.getDocumentByFile异常：" + e.getMessage(), e);
        }
        return null;
    }
