...
<div id="header_qq"  height="78">
	    ...
	    <td >
	        <div id="tabsI">
				...
				<s:iterator id="menuiterator" value="dataList" status="idx">
					<li id="head_<s:property value='#idx.index+1'/>" data-id="<s:property value='menuLink'/>" class="abcd">
						<a href="<s:property value='menuLink'/>" target="_parent"  onClick="changeHeadMenu(<s:property value='#idx.index+1'/>);">
                            ...
                            <s:if test="menuName=='康美中药城'"><i class="icon-pcchart"></i></s:if>
                            <s:if test="menuName=='中药城WAP'"><i class="icon-shouji"></i></s:if>
	...
	<a href="http://kmcas.kmb2b.com/logout?service=http://kmcms.kmb2b.com/casServer/login" target="_top" style="color:#fff;text-decoration: none; vertical-align: inherit;">退&nbsp;&nbsp;出</a>
	</div>
		</td>
	  </tr> 
	</table>
