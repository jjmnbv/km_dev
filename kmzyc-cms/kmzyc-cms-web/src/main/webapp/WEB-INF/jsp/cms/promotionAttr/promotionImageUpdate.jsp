...
<div width="100%" class="listTitle"  height="40">
	...
	<img src="/etc/images/icon_02.png"  />&nbsp;&nbsp;
		...
		<img src="/etc/images/icon_08.png" />&nbsp;&nbsp;活动管理
		 &nbsp;&nbsp;<img src="/etc/images/icon_08.png" />&nbsp;&nbsp;修改活动图片
		
		
	  </span>
</div>
<div  style="height:90%;overflow-y:auto; " >
<form id="AdcolumnAdd" name="AdcolumnAdd" action="/cms/PromotionAttr_Update.action" method="POST" enctype="multipart/form-data">
<input type="hidden" name="struts.token.name" value="struts.token" />
<input type="hidden" name="struts.token" value="UFJ5Q17IYGPSOWDXRK4AI6BDFYY0QLF" />
<input type="hidden" name="pro.promotionAttrId" value="<s:property value="pro.promotionAttrId"/>" />
<table width="60%" class="edit_table" cellpadding="3" cellspacing="0" border="1" bordercolor="#C7D3E2" style="border-collapse: collapse">
	...
	<tr> 
		...
		<td width="80%" align="left">
			<input name="pro.promotionTag" id="corporateName" type="text" value="<s:property value="pro.promotionTag"/>"/>
		</td>
	</tr>
	...
	<tr> 
		...
		<td width="80%">
			<input type=file name="resumefile" id="resumefile" onchange="javascript:setImagePreview();" style=" border: 1px #6699CC solid;">
									<div id="localImag">
									<s:if test="pro.promotionTinyIcon!=null">
									<img id="preview" width="300px" height="120px" src="<s:property value="pro.promotionTinyIcon"/>"/>
									</s:if>
									</div>
		</td>
	</tr>
	...
	<tr> 
		...
		<td width="80%">
			<input type=file name="resumefile2" id="resumefile2" onchange="javascript:setImagePreview2();" style=" border: 1px #6699CC solid;">
									<div id="localImag2">
									<s:if test="pro.promotionBigIcon!=null">
									<img id="preview2" width="300px" height="120px" style="diplay:none"  src="<s:property value="pro.promotionBigIcon"/>" /> </s:if></div>
		</td>
	</tr>
	...
	<tr> 
		...
		<td width="80%">
			<input type=file name="resumefile3" id="resumefile3" onchange="javascript:setImagePreview3();" style=" border: 1px #6699CC solid;">
									<div id="localImag3">
									<s:if test="pro.promotionImgFirst!=null">
									<img id="preview3" width="300px" height="120px" style="diplay:none"  src="<s:property value="pro.promotionImgFirst"/>" /></s:if></div>
		</td>
	</tr>
	...
	<tr> 
		...
		<td width="80%">
			...
			<div id="localImag4">
			<s:if test="pro.promotionImgSecond!=null">
			<img id="preview4" width="300px" height="120px" style="diplay:none"   src="<s:property value="pro.promotionImgSecond"/>"/></s:if></div>
		</td>
	</tr>
