       ...
       $(document).ready(function(){
        ...
        /** 选择团出窗口数据  **/
         function selectOneAccount(){
	           ...
	           parent.closeViewProductInfo(checkeds,themeId);
         }
...
<body>
<s:form  name="viewProductInfoForm" action="/cms/cmsThemeAction_gotoBandPage.action" method="post">
<table  width="98%" class="content_table" align="center" cellpadding="0" cellspacing="0"  style="margin:10 0 10 0px;">
	<tr>
		...
		<td>
			...
			<input type="hidden" id="cmsTemplate.themeId" name="cmsTemplate.themeId" value='<s:property value="cmsTheme.themeId"/>'>
...
<table width="98%" class="list_table" align="center" cellpadding="3" cellspacing="0" border="1" bordercolor="#C1C8D2">
	...
	<tr>
	     <td>
		     <s:if test="themeTemplateId==null">
