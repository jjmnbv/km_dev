...
<div width="100%" class="listTitle"  height="40">
	...
	<img src="/etc/images/icon_02.png"  />&nbsp;&nbsp;
		...
		<img src="/etc/images/icon_08.png" />&nbsp;&nbsp;添加手机端应用
	  </span>
</div>

		<div  style="height:90%;overflow-y:scroll; " >
		<s:form name="dateForm" id="dateForm" action="/cms/cmsAppManageAction_addAppManage.action" method="post" enctype="multipart/form-data">
		<s:token></s:token>
			<!-- 数据列表区域 -->
	...
	<tr> 
		...
		<td width="80%">
			...
			<%-- <input name="cmsAppManage.name" id="name" type="text" value=""/><span id="nameMsg" style="display:none;margin-left:5px;color:red;">手机端应用名称不能为空</span> --%>
		</td>
	</tr>
 	<tr> 
		<td width="20%" align="right"><font color="red">*</font>版本名：</td>
		<td width="80%">
		<input name="cmsAppManage.version" id="name" type="text" value=""/><span id="nameMsg" style="display:none;margin-left:5px;color:red;">版本名不能为空</span>
		</td>
	</tr>
	<tr> 
		<td width="20%" align="right"><font color="red">*</font>版本号：</td>
		<td width="80%">
		<input name="cmsAppManage.versioncode" id="name" type="text" value=""/><span id="nameMsg" style="display:none;margin-left:5px;color:red;">版本号不能为空</span>
		</td>
	</tr>
	<tr> 
	...
	<tr> 
		...
		<td width="80%"> 
			<!-- <input name="cmsAppManage.terrace" id="terrace" type="text" value="" class="newWidth"/> -->
	...
	<tr> 
		...
		<td width="80%"> 
			<textarea name="cmsAppManage.remark" style="height:300px;width:80%" id="remark"></textarea>
		</td>
	</tr>
</table>
			<!-- 底部 按钮条 -->
		...
		getDownload();
	 	$("#dateForm").validate({
	         rules: {
					...
					"cmsAppManage.download":{required:true}
		        	},
	...
	function getDownload(){
		...
		if(appName == 'ios版本'){
			$("#topAndor").empty();
			var html = '<input name="cmsAppManage.download" id="downloadMsg" type="text" value=""/><span id="downloadMsg" style="display:none;margin-left:5px;color:red;">下载地址不能为空</span>';
			$("#topIos").append(html);
		}else{
			$("#topIos").empty();
			$("#topAndor").append('<input type="file" name="resumefile" id="resumefile" style=" border: 1px #6699CC solid;">');
		}
	}
