...
<html>
	...
	<body >
		...
		<s:form name="windowDataForm"  id="windowDataForm"  onsubmit="return isCheck('dataIds');"
			action="/cms/cmsTemplateAction_addBandData.action" method="post">
			<s:token></s:token>
			<!-- 查询条件 -->
			...
			cellpadding="0" cellspacing="0">
				<tr>
					<td width="60%" valign="middle" colspan="2">
						...
						<input type="hidden" name="cmsTemplate.templateId" id="templateId" value="<s:property value='cmsTemplate.templateId'/>">
