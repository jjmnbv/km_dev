                  		 ...
                  		 $.ajax({
                  			 ...
                  			 var myData = eval("("+data+")");
         				         ...
         				         $str+="</td>";
         				      	 ...
         				      	 $str+="</td>";  
         				         $str+="<td>";
         				         if(typeof myData["orders"]!="undefined")
         				         {$str+=myData["orders"]}
         				         $str+="</td>";
         				         $str+="<td>";
         				         ...
         				         $str+="</td>";
         				         $str+="<td>";
         				         if(typeof myData["createDateInfo"]!="undefined")
         				         {$str+=myData["createDateInfo"]}
         				         $str+="</td>";
         				         $str+="<td>";
         				         if(typeof myData["createdInfo"]!="undefined")
         				         {$str+=myData["createdInfo"]}
         				         $str+="</td>";
         				         
         				         $str+="<td>";
        				         if(typeof myData["modifyDateInfo"]!="undefined")
        				         {$str+=myData["modifyDateInfo"]}
        				         $str+="</td>";
        				         
        				         $str+="<td>";
         				         if(typeof myData["modifiedInfo"]!="undefined")
         				         {$str+=myData["modifiedInfo"]}
         				         $str+="</td>";
