...
<div width="100%" class="listTitle"  height="40">
	...
	<img src="/etc/images/icon_02.png"  />&nbsp;&nbsp;
		...
		<img src="/etc/images/icon_08.png" />&nbsp;&nbsp;修改风格
	  </span>
</div>
<div  style="height:95%;" >
<s:form  id="addcmsSiteForm" name="addcmsSiteForm" action="/cms/cmsStylesAction_update.action" method="POST" enctype="multipart/form-data">
<s:token></s:token>
...
<table width="95%" class="edit_table" cellpadding="3" cellspacing="0" border="1" bordercolor="#C7D3E2" style="border-collapse: collapse">
	...
	<tr> 
		...
		<td width="80%">
			<input name="cmsStyles.stylesName" id="stylesName" type="text" value="<s:property value="cmsStyles.stylesName"/>"/>
		</td>
	</tr>
	<tr> 
		<td width="20%" align="right"><font color="red">*</font>风格描述：</td>
		<td width="80%">
			<input name="cmsStyles.stylesDescribe" id="stylesDescribe" type="text" value="<s:property value="cmsStyles.stylesDescribe"/>"/>
		</td>
	</tr>
	<tr> 
		<td width="20%" align="right"><font color="red">*</font>模板编号：</td>
		<td width="80%">
			<input name="cmsStyles.templateId" id="templateId" type="text" value="<s:property value="cmsStyles.templateId"/>"/>
			<input name="cmsStyles.stylesId" id="stylesId" type="hidden" value="<s:property value="cmsStyles.stylesId"/>"/>
			<input name="cmsStyles.siteId" id="siteId" type="hidden" value="<s:property value="cmsStyles.siteId"/>"/>
		</td>
	</tr>
	<tr>
	...
	<tr> 
		...
		<td width="80%">
	       ...
	       <div id="localImag"><img id="preview" src="<%=imageOut%><s:property value="cmsStyles.remark"/>"  <s:if test="cmsStyles.remark!=null"> width="300px" height="120px"</s:if>  width=-1 height=-1 style="diplay:none" /></div>
		</td>
	</tr>
	<tr> 
	...
	<tr> 
		<td colspan="2">
			<textarea   name="cmsStyles.content" id="content" style="height:500px;width:80%" style="height:300px;"><s:property value="cmsStyles.content" /></textarea>
		</td>
	</tr>
</table>
