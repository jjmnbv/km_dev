...
//				"cmsSite.channel":{required:true,maxlength:18},
 ...
 jQuery.validator.addMethod("unique", function(value, element) {
	 	...
	 	$.ajax({
	 		...
	 		async:false,
	 		data:"cmsSite.name="+value+"&siteId="+siteId,
        	type:'post',
...
<div  style="height:95%;" >
<s:form  id="addcmsSiteForm" name="addcmsSiteForm" action="/cms/cmsSite_editCmsSite.action" method="POST" enctype="multipart/form-data">
<s:token></s:token>
<input type="hidden" name="cmsSite.siteId" value="<s:property value="cmsSite.siteId"/>" id="siteId"/>
...
<table width="95%" class="edit_table" cellpadding="3" cellspacing="0" border="1" bordercolor="#C7D3E2" style="border-collapse: collapse">
	...
	<tr> 
		...
		<td width="80%">
			<input name="cmsSite.name" id="name" type="text" value="<s:property value="cmsSite.name"/>"/>
		</td>
	</tr>
	<tr> 
		<td width="20%" align="right"><font color="red">*</font>站点英文名称：</td>
		<td width="80%">
			<input name="cmsSite.engName" id="engName" type="text" value="<s:property value="cmsSite.engName"/>"/>
		</td>
	</tr>
	<tr> 
		<td width="20%" align="right"><font color="red">*</font>站点域名：</td>
		<td width="80%">
			<input name="cmsSite.url" id="url" type="text" value="<s:property value="cmsSite.url"/>"/>
		</td>
	</tr>
   <tr> 
		<td width="20%" align="right"><font color="red">*</font>页面模板路径：</td>
		<td width="80%">
			<input name="cmsSite.templatePath" id="templatePath" type="text" value="<s:property value="cmsSite.templatePath"/>"/>
		</td>
	</tr>
		<tr> 
		<td width="20%" align="right"><font color="red">*</font>页面输出路径：</td>
		<td width="80%">
			<input name="cmsSite.pageOutputPath" id="pageOutputPath" type="text" value="<s:property value="cmsSite.pageOutputPath"/>"/>
		</td>
	</tr>
	<%--<tr>
		<td width="20%" align="right"><font color="red">*</font>渠道信息：</td>
		<td width="80%">
			<input name="cmsSite.channel" id="pageOutputPath" onBlur="lastIn(this)" onKeyUp="ReplaceDot(this)" type="text" value="<s:property value="cmsSite.channel"/>"/><!-- *如果要添加多个渠道请以英文逗号隔开,如B2B,ZYC -->
		</td>
	</tr>--%>
	<tr> 
		...
		<td width="80%">
	        ...
	        <option value="0"  <s:if test="cmsSite.status==0">selected="selected"</s:if> >有效</option>
	        <option value="1" <s:if test="cmsSite.status==1">selected="selected"</s:if> >无效</option>
	        </select>
		</td>
	</tr>
	<tr> 
		...
		<td width="80%"> 
			<textarea name="cmsSite.remark" class="newWidth" id="remark"><s:property value="cmsSite.siteId"/></textarea>
		</td>
	</tr>
</table>
