						...
						<tr>
							...
							<td>	
								<img title="修改" style="cursor: pointer;"
									...
									onclick='editcmsSite(<s:property value="stylesId"/>)' />
									
								<img title="可视化" style="cursor: pointer;"
									src="/etc/images/tizheng.png"
									onclick='visualization(<s:property value="stylesId"/>)' />
								...
								<img title="删除" style="cursor: pointer;"
									...
									onclick='deleteByKey(<s:property value="stylesId"/>)' />
