...
<html>
	...
	<body >
		...
		<s:form class="templateForm" name="templateForm" id="templateForm" onsubmit="return checkAllTextValid(this)" action="/cms/cmsPageAction_tempSel.action" method="post">
				...
				<tr>
					...
					<td width="25%">
						类型:<select name="cmsTemplate.type">
							    ...
							    <option value="16" <s:if test="cmsTemplate.type==16">selected="selected"</s:if>>奖项模板</option>
							</select>
					</td>
					<!--<td>
			...
			<s:iterator id="custiterator" value="page.dataList">
				<tr>
					...
					<td><s:if test="type==0">窗口模板</s:if><s:if test="type==1">页面模板</s:if><s:if test="type==15">抽奖模板</s:if><s:if test="type==16">奖项模板</s:if></td>
	...
	<script type="text/javascript">
		...
		{
			$.ajax({
				url:"/cms/cmsPageAction_selTemplate.action?ajax=yes",
				data:"templateId="+id,
				type:"post",
