...
//dialog("选择活动信息","iframe:/cms/cmsPromotion_promotion.action","900px","530px","iframe");
 	$("#promotionAdd").validate({
	 	...
	 	$(".pro_hid").click(function(){
	 		...
	 		dialog("选择活动信息","iframe:/cms/cmsPromotion_promotion.action?operateType="+operateType,"900px","530px","iframe"); 
	 	});
 ...
 jQuery.validator.addMethod("compareTo", function(value, element) {  
       ...
       var ok="";
        ...
        data:{"outPut":value,"outPutType":3},
        async:false,
        type:'post',
        success:function (d) {
         if(d=="1"){
  ...
  $("input").attr("disabled",false); 
 	...
 	{  
		...
		if(json.content){
 		...
 		$("#id").val(json.obj.promotionId);
 		$("#name").val(json.obj.promotionName);  
 		$("#beginTime").val(json.begin);
 		$("#endTime").val(json.end);
 		$("#productFilterType").val(json.obj.productFilterType);
 		$("#promotionTypeId").val(json.obj.promotionTypeId);
 		$("#slogan").val(json.obj.slogan);
     ...
     function gotoList(){
 		var pageForm= window.document.getElementById("promotionAdd");
	...
	{
		$("#operateType").attr("disabled",false);
	}
 </script>
...
<div width="100%" class="listTitle"  height="40">
	...
	<img src="/etc/images/icon_02.png"  />&nbsp;&nbsp;
		...
		<img src="/etc/images/icon_08.png" />&nbsp;&nbsp;添加活动页面
	 </span>
</div>
<div  style="height:95%;" >
<s:form  id="promotionAdd"  action="/cms/cmsPromotion_promotionAdd.action" method="POST" enctype="multipart/form-data" onsubmit="cancelDisabled()">
<s:token></s:token>
<!-- hidden properties -->
<INPUT TYPE="hidden" name="isEnable" value="1">
<input type="hidden" name="cmspt.productFilterType" id="productFilterType"/>
<input type="hidden" name="cmspt.promotionTypeId" id="promotionTypeId"/>
<input type="hidden" name="cmspt.slogan" id="slogan"/>
<!-- keyWords -->
...
<table width="95%" class="edit_table" cellpadding="3" cellspacing="0" border="1" bordercolor="#C7D3E2" style="border-collapse: collapse">
	...
	<!-- error message -->
	<tr class="promotion_hid" > 
		<td width="20%" align="right"><font color="red">*</font>选择活动：</td>
		<td width="80%">
		    <input name="cmspt.name" id="name" type="text" value=""/>
			<INPUT TYPE="button" value="选择" onclick=""  class="pro_hid" style="cursor: pointer;">
		</td>
	</tr>
		<tr  style="display:none;"> 
		<td width="20%" align="right"><font color="red">*</font>ID：</td>
		<td width="80%">
			<input name="cmspt.id" id="id" type="text" value=""/>
		</td>
	</tr>
	<!--
	...
	<tr  style="display:none;"> 
		...
		<td width="80%">
			<input name="cmspt.status" id="name" type="text" value="0"/>
		</td>
	</tr>
	 -->
	...
	<tr class="hid" > 
		...
		<td width="80%">
		  <input name="cmspt.output" id="output" type="text" value=""/>
		</td>
	</tr>
	...
	<tr class="hid" style="display:none;">  
		...
		<td width="80%"> 
			<input name="cmspt.beginTime"  disabled="disabled" id="beginTime" type="text" value="" class="newWidth"/>
		</td>
	</tr>
	<tr class="hid" style="display:none;"> 
		<td width="20%" align="right">结束时间：</td>
		<td width="80%"> 
			<input name="cmspt.endTime"  disabled="disabled" id="endTime" type="text" value="" class="newWidth"/>
		</td>
	</tr>
	<tr>
		<td width="20%" align="right">APP显示位置：</td>
		<td width="80%">
			<select name="cmspt.operateType" id="operateType" >
	...
	<tr> 
		<td width="20%" align="right">上传活动图片4(<span id="pic4">MTK系统</span>)：</td>
	...
	<tr class="hid"> 
		<td colspan="2">
			<textarea   name="cmspt.content" id="content" cols="100" rows="8" style="height:300px;"></textarea>
		</td>
	</tr>
	...
	<tr class="hid" > 
		...
		<td width="80%"> 
			<textarea name="cmspt.p2" style="height:100px;width:60%"></textarea>
		</td>
	</tr>
</table>
<!-- 底部 按钮条 -->
...
<!--  
<tr class="hid_" > 
		<td width="20%" align="right"><font color="red">提示：</font></td>
		<td width="80%"> 
           <font color="red"> 请选择活动！！！</font>
		</td>
	</tr>
	-->
	...
	<tr> 
		<td align="left">
			<INPUT class="saveBtn"  type="button" onclick="Submit()" value="">
            &nbsp;&nbsp;
