...
<html>
	<head>
        ...
        /** 关闭弹出层操作  **/
        function  closeViewProductInfo(checkeds,templateId){
        	closeThis();
       ...
       //     alert("checkeds:"+checkeds);
             window.location.href="/cms/cmsTemplateAction_gotoConfirmBand.action?cmsTemplate.templateId="+templateId+"&checkeds="+checkeds;
        ...
        function gotoBandList(actionType) {
            ...
            dialog("选择窗口信息","iframe:/cms/cmsTemplateAction_"+actionType+".action?cmsTemplate.templateId="+templateId,"900px","530px","iframe");
        }
        
         
            
    /** 单条删除客户等级信息  **/
    function  deleteByKey(id,templateId){
         if(confirm("是否确认删除? ")==true){
          
           location.href="/cms/cmsTemplateAction_delBandData.action?cmsTemplateRelation.relationId="+id+"&cmsTemplate.templateId="+templateId;
         }
    }
    ...
    function deleteSelected(id){
         ...
         if (count == 0) {
        	  ...
        	  //     var themeId= $("#themeId").val();
        	     //  cmsThemeTemplate.themeId="+themeId
                  document.pageForm.action="/cms/cmsTemplateAction_delBandDatas.action";
 	...
 	document.pageForm.action="/cms/cmsTemplateAction_queryVarTemplate.action";
 	document.pageForm.submit();
	...
	<body>
		...
		<s:form name="pageForm"  id="pageForm"  onsubmit="return checkAllTextValid(this)" 
			action="/cms/cmsTemplateAction_gotoBandList.action" method="post">
			<s:token></s:token>
			...
			<tr>  
				<td colspan="4"  align="center" >
				    <input type="button" value="绑定变量窗口" onclick="gotoBandList('gotoWindowList');"   style="cursor:pointer;"/>&nbsp;
			...
			<table width="98%" class="list_table" cellpadding="3" align="center"
				...
				<s:iterator id="custiterator" value="page.dataList">
					<tr class="dataTr">
						<td width="5%">
							<input type="checkbox" name="dataIds" value="<s:property value='flagId'/>">
						</td>
						<td>
						...
						<td> 
						   <!--     	<img title="绑定" style="cursor: pointer;" src="/etc/images/icon_select.png"   onclick="gotoBandList('gotoBandPage');"/>--> 
						     ...
						     <img title="删除" style="cursor: pointer;" src="/etc/images/icon_delete.png"   onclick="deleteByKey(<s:property value='flagId'/>,<s:property value='cmsTemplate.templateId'/>);" />
						</td>
					</tr>
				</s:iterator>
			</table>
