...
<s:form  id="AdcolumnAdd" name="AdcolumnAdd" action="/cms/Adv_Add.action" method="POST" enctype="multipart/form-data">
<s:token></s:token>
<!-- hidden properties -->
...
<table width="95%" class="edit_table" cellpadding="3" cellspacing="0" border="1" bordercolor="#C7D3E2" style="border-collapse: collapse">
	...
	<!-- error message -->
	<tr> <input type="hidden" name="adminType" value="<s:property value="adminType"/>"/>
		<td width="20%" align="right"><font color="red">*</font>广告名：</td>
		<td width="80%" align="left">
			<input name="cmsAdv.name" id="corporateName" type="text" value=""/>
		</td>
	</tr>
	...
	<tr> 
		...
		<td width="80%"> 
	        ...
	        <input type="hidden" name="cmsAdv.adcolumnId" id="theadcolumnId" value=""/>
		</td>
	</tr>
	...
	<tr> 
		...
		<td width="80%"> 
	        ...
	        <option value="1"  selected="selected">单张</option>
	        <option value="2"  selected="selected">多张切换</option>
	        <option value="3"  selected="selected">FLASH</option>
	        </select>
		</td>
	</tr>
    <tr style="display:none;"> 
		...
		<td width="80%"> 
			<input type="radio" checked='checked' name="cmsAdv.status" value="0">开
			<input type="radio" name="cmsAdv.status" value="1">关
	...
	<tr> 
		...
		<td width="80%"> 
			<input name="cmsAdv.beginTime" id="beginTime" type="text" readonly="readonly" value="" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})">
		</td>
	</tr>
	<tr> 
		<td width="20%" align="right"><font color="red">*</font>终止时间：</td>
		<td width="80%"> 
		<input name="cmsAdv.endTime"  id="endTime" type="text" readonly="readonly" value="" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})">
		</td>
	</tr>
	<tr> 
		<td width="20%" align="right">广告链接：</td>
		<td width="80%">
			<input name="cmsAdv.url" id="url" type="text" value="" />
		</td>
	</tr>
	<tr> 
	...
	<tr> 
		...
		<td width="80%">
			<input name="cmsAdv.url2" id="url2" type="text" value="" />
		</td>
	</tr>
	<tr> 
	...
	<tr> 
		...
		<td width="80%">
			<input name="cmsAdv.url3" id="url3" type="text" value="" />
		</td>
	</tr>
	<tr> 
	...
	<tr> 
		...
		<td width="80%">
			<input name="cmsAdv.url4" id="url4" type="text" value="" />
		</td>
	</tr>
	<tr> 
		...
		<td width="80%">
			<input name="cmsAdv.p2" id="p2" type="text" value="" />
		</td>
	</tr>
	<tr> 
		...
		<td width="80%">
			...
			<div id="localImag4"><img id="preview5" width=-1 height=-1 style="diplay:none" /></div>
		</td>
	</tr>
	<tr> 
		...
		<td width="80%">
			<input type="text" name="cmsAdv.unitName" id="pic" size="45">
		</td>
	</tr>
	<tr> 
		...
		<td width="80%">
			<input type="text" name="cmsAdv.linkman" id="pic" size="45">
		</td>
	</tr>
	<tr> 
		...
		<td width="80%">
			<input type="text" name="cmsAdv.contact" id="pic" size="45">
		</td>
	</tr>
	<tr> 
	...
	<tr> 
		<td colspan="2">
			<textarea   name="cmsAdv.content" id="content" cols="100" rows="8" style="height:300px;"></textarea>
		</td>
	</tr>
 ...
 $().ready(function(){
	 ...
	 var adcolumnArray;
		$.ajax({
			...
			$('#adcolumn').autocomplete({
			    	lookup: adcolumnArray,
			        minChars: 0,
