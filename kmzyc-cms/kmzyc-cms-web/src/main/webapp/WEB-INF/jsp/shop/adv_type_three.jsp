                    ...
                    <!--  
                        <div class="ui-form-item">
                            ...
                            <input type="hidden" name="cmsWindowDatas[3].user_defined_type" value="1"/>
                             ...
                             <input type="hidden" name="cmsWindowDatas[3].sort" value="4"/>
                            ...
                            <input type="hidden" name="cmsWindowDatas[4].user_defined_type" value="1"/>
                             ...
                             <input type="hidden" name="cmsWindowDatas[4].sort" value="5"/>
                        ...
                        <div class="ui-form-item">
                            ...
                            <div class="ui-form-explain">
                                <label class="ui-tips"></label>
                               
                                <!--  <label><span></span> <input type="text" value="" class="ui-input ui-input280" style=" width: 66px;">
                                    px</label>-->
                        ...
                        <div class="ui-tab">
                            <div class="ui-tab-trigger">
                                <ul class="ui-tab-user" id="pictab">
                                    ...
                                    <li class="ui-tab-user-item  <s:if test="tabId=='tab0'||tabId==''">ui-tab-user-item-current</s:if>"  id="tab0">
                                        <a href="javascript:void(0);">图片1</a>
                                    </li>
                                    <li class="ui-tab-user-item <s:if test="tabId=='tab1'">ui-tab-user-item-current</s:if>" id="tab1">
                                        <a href="javascript:void(0);">图片2</a>
                                    </li>
                                     <li class="ui-tab-user-item <s:if test="tabId=='tab2'">ui-tab-user-item-current</s:if>" id="tab2">
                                        <a href="javascript:void(0);">图片3</a>
                                    </li>
                                     <li class="ui-tab-user-item <s:if test="tabId=='tab3'">ui-tab-user-item-current</s:if>" id="tab3">
                                        <a href="javascript:void(0);">图片4</a>
                                    </li>
                                     <li class="ui-tab-user-item <s:if test="tabId=='tab4'">ui-tab-user-item-current</s:if>" id="tab4">
                            ...
                            <div class="ui-tab-cnt">
                                ...
                                <div class="ui-tab-cnt-item"  id="pictab0"  <s:if test="tabId!='tab0'&&tabId!=''">style="display: none;"</s:if>>
                                    <div class="ui-form-item">
                                ...
                                <div class="ui-tab-cnt-item"   id="pictab1" <s:if test="tabId!='tab1'">style="display: none;"</s:if>>
                                    <div class="ui-form-item">
                                        <label class="ui-label" for="">上传图片</label>
                                        <span class="ui-form-explain">
                                  ...
                                  <div class="ui-tab-cnt-item"  id="pictab2" <s:if test="tabId!='tab2'">style="display: none;"</s:if>>
                                    <div class="ui-form-item">
                                        <label class="ui-label" for="">上传图片</label>
                                        <span class="ui-form-explain">
                                      <!--    <a class="ui-widget-btn" href="javascript:void(0)"><span>选择宝贝</span></a> 未选择文件 -->
                                  ...
                                  <div class="ui-tab-cnt-item"   id="pictab3" <s:if test="tabId!='tab3'">style="display: none;"</s:if>>
                                    <div class="ui-form-item">
                                        <label class="ui-label" for="">上传图片</label>
                                        <span class="ui-form-explain">
                                      <!--    <a class="ui-widget-btn" href="javascript:void(0)"><span>选择宝贝</span></a> 未选择文件 -->
                                  ...
                                  <div class="ui-tab-cnt-item"   id="pictab4" <s:if test="tabId!='tab4'">style="display: none;"</s:if>>
                                    <div class="ui-form-item">
                                        <label class="ui-label" for="">上传图片</label>
                                        <span class="ui-form-explain">
                                      <!--    <a class="ui-widget-btn" href="javascript:void(0)"><span>选择宝贝</span></a> 未选择文件 -->
...
function onsave(){
  ...
  var pageForm= window.document.getElementById("dateForm");
	...
	var resumefile3=$("#resumefile3").val();
	var resumefile4=$("#resumefile4").val();
	
	var preview0=$("#preview0").attr("src");
	var preview1=$("#preview1").attr("src");
	var preview2=$("#preview2").attr("src");
	var preview3=$("#preview3").attr("src");
	var preview4=$("#preview3").attr("src");
	
	if(resumefile0==""&&resumefile1==""&&resumefile2==""&&resumefile3==""&&resumefile4==""&&
	preview0=="/etc/resshop/images/template/u508.png"&&preview1=="/etc/resshop/images/template/u508.png"&&preview2=="/etc/resshop/images/template/u508.png"&&preview3=="/etc/resshop/images/template/u508.png"&&preview4=="/etc/resshop/images/template/u508.png"){
	       alert("请上传图片！");
			return ;
	}
    ...
    if(resumefile1!=""){
     ...
     if(resumefile2!=""){
       ...
       if(resumefile3!=""){
       var type3=resumefile3.substring(resumefile3.lastIndexOf("\.")+1,resumefile3.length);
        if (type3.toUpperCase()!="GIF" && type3.toUpperCase()!="JPG" && type3.toUpperCase()!="PNG"&& type3.toUpperCase()!="JPEG"){
            alert("第四张图片格式不对！");
            return ;
        }   
    }
     ...
     if(resumefile4!=""){
       var type4=resumefile4.substring(resumefile4.lastIndexOf("\.")+1,resumefile4.length);
        if (type4.toUpperCase()!="GIF" && type4.toUpperCase()!="JPG" && type4.toUpperCase()!="PNG"&& type4.toUpperCase()!="JPEG"){
            alert("第五张图片格式不对！");
            return ;
        }   
    }
...
$(function(){
	   $("#dateForm").validate({
               rules: {
					...
					"cmsWindowDatas[3].user_defined_url":{checks:true},
					"cmsWindowDatas[4].user_defined_url":{checks:true}	
				}
        });
