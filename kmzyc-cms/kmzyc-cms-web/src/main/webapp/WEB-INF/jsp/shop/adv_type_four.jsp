...
<script src="/etc/js/dialog.js"></script>
	...
	<message-resources parameter="LabelResources" key="labels"  null="false"></message-resources>
</head>
                ...
                <form id="" action="#" method="post" name="" class="ui-form">
                    ...
                    <!--  
                        ...
                        <div class="ui-form-item">
                            ...
                            <div class="ui-form-explain">
                                <label class="ui-tips"><bean:message bundle="labels" key="adv_type_four_V1"/></label>
...
function onsave(){
  ...
  var pageForm= window.document.getElementById("dateForm");
	...
	var preview3=$("#preview3").attr("src");
		...
		if(resumefile0==""&&resumefile1==""&&resumefile2==""&&resumefile3==""&&
	preview0=="/etc/resshop/images/template/u508.png"&&preview1=="/etc/resshop/images/template/u508.png"&&preview2=="/etc/resshop/images/template/u508.png"&&preview3=="/etc/resshop/images/template/u508.png"){
	       alert("请上传图片！");
			return ;
	}
	    if(resumefile0!=""){
