...
<html>
                  	 ...
                  	 for(var k = 0;k<checks.length;k++){
                  		 $.ajax({
                  			 ...
                  			 var myData = eval("("+data+")");
                  			 	 ...
                  			 	 $str='';
         				         $str+="<tr class='dataTr'>";											     
         				         $str+="<td><input type='checkbox' name='dataIds' value='"+myData['brandId']+"' onclick=checkboxChange(); /></td>";
         				      	 $str+="<td>";
         				      	 if(typeof myData["brandName"]!="undefined")
         				      	 {$str+=myData["brandName"];}
         				      	 $str+="</td>";  
         				         $str+="<td>";
         				         if(typeof myData["nation"]!="undefined")
         				         {$str+=myData["nation"];}
         				         $str+="</td>";
         				         $str+="<td>";
         				         if(typeof myData["engName"]!="undefined")
         				         {$str+=myData["engName"];}
         				         $str+="</td>";
         				         $str+="<td>";
         				         if(typeof myData["homepage"]!="undefined")
         				         {$str+=myData["homepage"];}
         				         $str+="</td>";
         				         $str+="<td><img src='"+picturePreviewPath+"/";
         				         if(typeof myData["logoPath"]!="undefined")
         				         {$str+=myData["logoPath"];}
         				         $str+="'  />";
         				         $str+="</td>";  
	...
	<body onload="loadData();">
		...
		<s:set name="son_name" value="'品牌数据'" scope="request" />
