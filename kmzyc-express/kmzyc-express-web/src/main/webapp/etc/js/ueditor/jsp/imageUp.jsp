    <%@ page language="java" contentType="text/html; charset=utf-8"
        ...
        <%@ page import="com.pltfm.app.util.Uploader" %>
...
response.getWriter().print("{'original':'"+up.getOriginalName()+"','url':'"+up.getUrl().replaceAll(dir, "")+"','title':'"+up.getTitle()+"','state':'"+up.getState()+"'}");
%>
