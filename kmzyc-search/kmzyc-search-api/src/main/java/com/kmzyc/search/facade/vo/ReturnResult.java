...
public class ReturnResult<T> {
   ...
   * 返回二级运营类目
   */
  private Map<Integer, Map<String, Object>> secondCategroyMap;
  ...
  public Map<Integer, Map<String, Object>> getSecondCategroyMap() {
    return secondCategroyMap;
  }

  public void setSecondCategroyMap(Map<Integer, Map<String, Object>> secondCategroyMap) {
    this.secondCategroyMap = secondCategroyMap;
  }
}
