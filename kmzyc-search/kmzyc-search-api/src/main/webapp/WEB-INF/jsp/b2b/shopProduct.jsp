...
<link rel="stylesheet" href="<%=staticUrl%>/resshop/css/default/core/global-min.css"/>
<link rel="stylesheet" href="<%=staticUrl%>/resshop/css/default/core/layout-min.css"/>
<link rel="stylesheet" href="<%=staticUrl%>/resshop/css/default/core/tpl.css"/>
                                ...
                                <div class="co-bd">
                                    <ul class="search-lst">
                                        ...
                                        <li>
                                            ...
                                            <div class="p-price">
                                                <del class="mpriceTag" >市场价：￥<fmt:formatNumber type="number" value="${product.mprice }" pattern="0.00" /></del>
